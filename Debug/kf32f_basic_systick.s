	...
	.stabs	"../src/kf32f_basic_systick.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.stabn	162,0,0,0
	.stabs	"SYSTICK_InitTypeDef:t(1,1)=(1,2)=s12m_Period:(3,6),0,32;m_Clock:(3,6),32,32;m_SysTickINT:(3,6),64,32;;",128,0,29,0
	.stabn	162,0,0,0
...
.Lscope1:
	...
	.align	1
	.stabs	"SYSTICK_Configuration:F(0,15)",36,0,43,SYSTICK_Configuration
	.stabs	"Clock:p(3,6)",160,0,43,4
	.stabs	"SysTickINT:p(3,6)",160,0,43,8
	.stabs	"Reload:p(3,6)",160,0,44,12
	.export	SYSTICK_Configuration
	.type	SYSTICK_Configuration, @function
SYSTICK_Configuration:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_systick.c",132,0,0,.Ltext2
.Ltext2:
...
.Lscope2:
	...
	.align	1
	.stabs	"SYSTICK_Cmd:F(0,15)",36,0,87,SYSTICK_Cmd
	.stabs	"NewState:p(2,2)",160,0,87,0
	.export	SYSTICK_Cmd
	.type	SYSTICK_Cmd, @function
SYSTICK_Cmd:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_systick.c",132,0,0,.Ltext3
.Ltext3:
	.stabn	68,0,88,.LM11-.LFBB3
.LM11:
.LFBB3:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,93,.LM12-.LFBB3
.LM12:
	LD.w	r5,[sp]
	CMP	r5,#0
	JZ	.L5
...
.Lscope3:
	...
	.align	1
	.stabs	"SYSTICK_Clock_Config:F(0,15)",36,0,114,SYSTICK_Clock_Config
	.stabs	"SysClock:p(3,6)",160,0,114,0
	.export	SYSTICK_Clock_Config
	.type	SYSTICK_Clock_Config, @function
SYSTICK_Clock_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_systick.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,115,.LM16-.LFBB4
.LM16:
.LFBB4:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,120,.LM17-.LFBB4
.LM17:
	LD.w	r5,[sp]
	CMP	r5,#0
	JZ	.L8
	.stabn	68,0,123,.LM18-.LFBB4
.LM18:
	LD	r5,#1075839136
// inline asm begin
...
.Lscope4:
	...
	.align	1
	.stabs	"SYSTICK_Systick_INT_Enable:F(0,15)",36,0,139,SYSTICK_Systick_INT_Enable
	.stabs	"SysClock:p(3,6)",160,0,139,0
	.export	SYSTICK_Systick_INT_Enable
	.type	SYSTICK_Systick_INT_Enable, @function
SYSTICK_Systick_INT_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_systick.c",132,0,0,.Ltext5
.Ltext5:
	.stabn	68,0,140,.LM21-.LFBB5
.LM21:
.LFBB5:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,145,.LM22-.LFBB5
.LM22:
	LD.w	r5,[sp]
	CMP	r5,#0
	JZ	.L11
	.stabn	68,0,148,.LM23-.LFBB5
.LM23:
	LD	r5,#1075839136
// inline asm begin
...
.Lscope5:
	...
	.align	1
	.stabs	"SYSTICK_Get_Count_Zero_Flag:F(2,4)",36,0,163,SYSTICK_Get_Count_Zero_Flag
	.stabs	"ATIMx:p(0,16)=*(2,56)",160,0,163,0
	.export	SYSTICK_Get_Count_Zero_Flag
	.type	SYSTICK_Get_Count_Zero_Flag, @function
SYSTICK_Get_Count_Zero_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_systick.c",132,0,0,.Ltext6
.Ltext6:
	.stabn	68,0,164,.LM26-.LFBB6
.LM26:
.LFBB6:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,166,.LM27-.LFBB6
.LM27:
	LD	r5,#1075839136
	LD.w	r4,[r5]
	MOV	r5,#1
	...
	CMP	r5,#0
	JZ	.L14
	.stabn	68,0,169,.LM28-.LFBB6
.LM28:
	MOV	r5,#1
	JMP	.L15
.L14:
	.stabn	68,0,174,.LM29-.LFBB6
.LM29:
	MOV	r5,#0
.L15:
	.stabn	68,0,176,.LM30-.LFBB6
.LM30:
	MOV	r0,r5
	ADD	sp,#4
	JMP	lr
...
.Lscope6:
	...
	.align	1
	.stabs	"SYSTICK_Reload_Config:F(0,15)",36,0,185,SYSTICK_Reload_Config
	.stabs	"Reload:p(3,6)",160,0,185,0
	.export	SYSTICK_Reload_Config
	.type	SYSTICK_Reload_Config, @function
SYSTICK_Reload_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_systick.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,186,.LM31-.LFBB7
.LM31:
.LFBB7:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,191,.LM32-.LFBB7
.LM32:
	LD	r5,#1075839136
	LD.w	r4,[sp]
	ST.w	[r5+#1],r4
	.stabn	68,0,192,.LM33-.LFBB7
.LM33:
	ADD	sp,#4
	JMP	lr
...
.Lscope7:
	...
	.align	1
	.stabs	"SYSTICK_Counter_Updata:F(0,15)",36,0,201,SYSTICK_Counter_Updata
	.export	SYSTICK_Counter_Updata
	.type	SYSTICK_Counter_Updata, @function
SYSTICK_Counter_Updata:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_systick.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,202,.LM34-.LFBB8
.LM34:
.LFBB8:
	.stabn	68,0,205,.LM35-.LFBB8
.LM35:
	LD	r5,#1075839136
	MOV	r4,#0
	ST.w	[r5+#2],r4
	.stabn	68,0,206,.LM36-.LFBB8
.LM36:
	JMP	lr
...
.Lscope8:
	...
	.align	1
	.stabs	"SYSTICK_Get_Reload:F(3,6)",36,0,214,SYSTICK_Get_Reload
	.export	SYSTICK_Get_Reload
	.type	SYSTICK_Get_Reload, @function
SYSTICK_Get_Reload:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_systick.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,215,.LM37-.LFBB9
.LM37:
.LFBB9:
	SUB	sp,#4
	.stabn	68,0,216,.LM38-.LFBB9
.LM38:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,219,.LM39-.LFBB9
.LM39:
	LD	r5,#1075839136
	LD.w	r4,[r5+#1]
	LD	r5,#16777215
	ANL	r5,r4,r5
	ST.w	[sp],r5
	.stabn	68,0,221,.LM40-.LFBB9
.LM40:
	LD.w	r5,[sp]
	.stabn	68,0,222,.LM41-.LFBB9
.LM41:
	MOV	r0,r5
	ADD	sp,#4
	JMP	lr
...
.Lscope9:
	...
	.align	1
	.stabs	"SYSTICK_Get_Counter:F(3,6)",36,0,230,SYSTICK_Get_Counter
	.export	SYSTICK_Get_Counter
	.type	SYSTICK_Get_Counter, @function
SYSTICK_Get_Counter:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_systick.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,231,.LM42-.LFBB10
.LM42:
.LFBB10:
	SUB	sp,#4
	.stabn	68,0,232,.LM43-.LFBB10
.LM43:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,235,.LM44-.LFBB10
.LM44:
	LD	r5,#1075839136
	LD.w	r4,[r5+#2]
	LD	r5,#16777215
	ANL	r5,r4,r5
	ST.w	[sp],r5
	.stabn	68,0,237,.LM45-.LFBB10
.LM45:
	LD.w	r5,[sp]
	.stabn	68,0,238,.LM46-.LFBB10
.LM46:
	MOV	r0,r5
	ADD	sp,#4
	JMP	lr
	.size	SYSTICK_Get_Counter, .-SYSTICK_Get_Counter
	.stabs	"tmpreg:(3,6)",128,0,232,0
