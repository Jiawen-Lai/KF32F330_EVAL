	...
	.stabs	"../src/kf32f_basic_aes.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.stabn	162,0,0,0
	.stabs	"AES_InitTypeDef:t(1,1)=(1,2)=s24m_OFB:(3,6),0,32;m_ClockSelect:(3,6),32,32;m_ClockDiv:(3,6),64,32;m_Run:(3,6),96,32;m_FinishIntEn:(3,6),128,32;m_FinishIntClr:(3,6),160,32;;",128,0,40,0
	.stabn	162,0,0,0
...
.Lscope1:
	...
	.align	1
	.stabs	"AES_Reset:F(0,15)",36,0,37,AES_Reset
	.export	AES_Reset
	.type	AES_Reset, @function
AES_Reset:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_aes.c",132,0,0,.Ltext2
.Ltext2:
	.stabn	68,0,38,.LM3-.LFBB2
.LM3:
.LFBB2:
	PUSH	lr
	.stabn	68,0,39,.LM4-.LFBB2
.LM4:
	MOV	r0,#1
	LSL	r0,#14
	MOV	r1,#1
...
.Lscope2:
	...
	.align	1
	.stabs	"AES_Configuration:F(0,15)",36,0,50,AES_Configuration
	.stabs	"AESInitStruct:p(0,16)=*(1,1)",160,0,50,4
	.export	AES_Configuration
	.type	AES_Configuration, @function
AES_Configuration:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_aes.c",132,0,0,.Ltext3
.Ltext3:
	.stabn	68,0,51,.LM8-.LFBB3
.LM8:
.LFBB3:
	PUSH	{r6, lr}
	SUB	sp,#8
	ST.w	[sp+#1],r0
	.stabn	68,0,52,.LM9-.LFBB3
.LM9:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,68,.LM10-.LFBB3
.LM10:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5]
	.stabn	68,0,69,.LM11-.LFBB3
.LM11:
	LD.w	r4,[sp+#1]
	LD.w	r4,[r4+#1]
	.stabn	68,0,68,.LM12-.LFBB3
.LM12:
	ORL	r4,r5,r4
	.stabn	68,0,70,.LM13-.LFBB3
.LM13:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#2]
...
.LM14:
	ORL	r4,r4,r5
	.stabn	68,0,71,.LM15-.LFBB3
.LM15:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#3]
	.stabn	68,0,70,.LM16-.LFBB3
.LM16:
	ORL	r4,r4,r5
...
.LM21:
	...
	MOV	r5,r0
	ST.w	[r6],r5
	.stabn	68,0,79,.LM22-.LFBB3
.LM22:
	ADD	sp,#8
	POP	{r6, pc}
	.size	AES_Configuration, .-AES_Configuration
	.stabs	"tmpreg:(3,6)",128,0,52,0
...
.Lscope3:
	...
	.align	1
	.stabs	"AES_Struct_Init:F(0,15)",36,0,86,AES_Struct_Init
	.stabs	"AESInitStruct:p(0,16)",160,0,86,0
	.export	AES_Struct_Init
	.type	AES_Struct_Init, @function
AES_Struct_Init:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_aes.c",132,0,0,.Ltext4
.Ltext4:
...
.LM24:
	...
	MOV	r4,#0
	ST.w	[r5],r4
	.stabn	68,0,91,.LM25-.LFBB4
.LM25:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#1],r4
	.stabn	68,0,93,.LM26-.LFBB4
.LM26:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#2],r4
	.stabn	68,0,95,.LM27-.LFBB4
.LM27:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#3],r4
	.stabn	68,0,97,.LM28-.LFBB4
.LM28:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#4],r4
...
.Lscope4:
	...
	.align	1
	.stabs	"AES_KEY0_DATA:F(0,15)",36,0,108,AES_KEY0_DATA
	.stabs	"DATA:p(3,6)",160,0,108,0
	.export	AES_KEY0_DATA
	.type	AES_KEY0_DATA, @function
AES_KEY0_DATA:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_aes.c",132,0,0,.Ltext5
.Ltext5:
	.stabn	68,0,109,.LM31-.LFBB5
.LM31:
.LFBB5:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,111,.LM32-.LFBB5
.LM32:
	LD	r5,#1073751808
	LD.w	r4,[sp]
	ST.w	[r5+#4],r4
	.stabn	68,0,112,.LM33-.LFBB5
.LM33:
	ADD	sp,#4
	JMP	lr
...
.Lscope5:
	...
	.align	1
	.stabs	"AES_KEY1_DATA:F(0,15)",36,0,114,AES_KEY1_DATA
	.stabs	"DATA:p(3,6)",160,0,114,0
	.export	AES_KEY1_DATA
	.type	AES_KEY1_DATA, @function
AES_KEY1_DATA:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_aes.c",132,0,0,.Ltext6
.Ltext6:
	.stabn	68,0,115,.LM34-.LFBB6
.LM34:
.LFBB6:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,117,.LM35-.LFBB6
.LM35:
	LD	r5,#1073751808
	LD.w	r4,[sp]
	ST.w	[r5+#5],r4
	.stabn	68,0,118,.LM36-.LFBB6
.LM36:
	ADD	sp,#4
	JMP	lr
...
.Lscope6:
	...
	.align	1
	.stabs	"AES_KEY2_DATA:F(0,15)",36,0,120,AES_KEY2_DATA
	.stabs	"DATA:p(3,6)",160,0,120,0
	.export	AES_KEY2_DATA
	.type	AES_KEY2_DATA, @function
AES_KEY2_DATA:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_aes.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,121,.LM37-.LFBB7
.LM37:
.LFBB7:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,123,.LM38-.LFBB7
.LM38:
	LD	r5,#1073751808
	LD.w	r4,[sp]
	ST.w	[r5+#6],r4
	.stabn	68,0,124,.LM39-.LFBB7
.LM39:
	ADD	sp,#4
	JMP	lr
...
.Lscope7:
	...
	.align	1
	.stabs	"AES_KEY3_DATA:F(0,15)",36,0,126,AES_KEY3_DATA
	.stabs	"DATA:p(3,6)",160,0,126,0
	.export	AES_KEY3_DATA
	.type	AES_KEY3_DATA, @function
AES_KEY3_DATA:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_aes.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,127,.LM40-.LFBB8
.LM40:
.LFBB8:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,129,.LM41-.LFBB8
.LM41:
	LD	r5,#1073751808
	LD.w	r4,[sp]
	ST.w	[r5+#7],r4
	.stabn	68,0,130,.LM42-.LFBB8
.LM42:
	ADD	sp,#4
	JMP	lr
...
.Lscope8:
	...
	.align	1
	.stabs	"AES_INPUT0_DATA:F(0,15)",36,0,137,AES_INPUT0_DATA
	.stabs	"DATA:p(3,6)",160,0,137,0
	.export	AES_INPUT0_DATA
	.type	AES_INPUT0_DATA, @function
AES_INPUT0_DATA:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_aes.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,138,.LM43-.LFBB9
.LM43:
.LFBB9:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,140,.LM44-.LFBB9
.LM44:
	LD	r5,#1073751808
	LD.w	r4,[sp]
	ST.w	[r5+#8],r4
	.stabn	68,0,141,.LM45-.LFBB9
.LM45:
	ADD	sp,#4
	JMP	lr
...
.Lscope9:
	...
	.align	1
	.stabs	"AES_INPUT1_DATA:F(0,15)",36,0,143,AES_INPUT1_DATA
	.stabs	"DATA:p(3,6)",160,0,143,0
	.export	AES_INPUT1_DATA
	.type	AES_INPUT1_DATA, @function
AES_INPUT1_DATA:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_aes.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,144,.LM46-.LFBB10
.LM46:
.LFBB10:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,146,.LM47-.LFBB10
.LM47:
	LD	r5,#1073751808
	LD.w	r4,[sp]
	ST.w	[r5+#9],r4
	.stabn	68,0,147,.LM48-.LFBB10
.LM48:
	ADD	sp,#4
	JMP	lr
...
.Lscope10:
	...
	.align	1
	.stabs	"AES_INPUT2_DATA:F(0,15)",36,0,149,AES_INPUT2_DATA
	.stabs	"DATA:p(3,6)",160,0,149,0
	.export	AES_INPUT2_DATA
	.type	AES_INPUT2_DATA, @function
AES_INPUT2_DATA:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_aes.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,150,.LM49-.LFBB11
.LM49:
.LFBB11:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,152,.LM50-.LFBB11
.LM50:
	LD	r5,#1073751808
	LD.w	r4,[sp]
	ST.w	[r5+#10],r4
	.stabn	68,0,153,.LM51-.LFBB11
.LM51:
	ADD	sp,#4
	JMP	lr
...
.Lscope11:
	...
	.align	1
	.stabs	"AES_INPUT3_DATA:F(0,15)",36,0,155,AES_INPUT3_DATA
	.stabs	"DATA:p(3,6)",160,0,155,0
	.export	AES_INPUT3_DATA
	.type	AES_INPUT3_DATA, @function
AES_INPUT3_DATA:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_aes.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,156,.LM52-.LFBB12
.LM52:
.LFBB12:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,158,.LM53-.LFBB12
.LM53:
	LD	r5,#1073751808
	LD.w	r4,[sp]
	ST.w	[r5+#11],r4
	.stabn	68,0,159,.LM54-.LFBB12
.LM54:
	ADD	sp,#4
	JMP	lr
...
.Lscope12:
	...
	.align	1
	.stabs	"GET_AES_OUTPUT0_DATA:F(3,6)",36,0,167,GET_AES_OUTPUT0_DATA
	.export	GET_AES_OUTPUT0_DATA
	.type	GET_AES_OUTPUT0_DATA, @function
GET_AES_OUTPUT0_DATA:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_aes.c",132,0,0,.Ltext13
.Ltext13:
	.stabn	68,0,168,.LM55-.LFBB13
.LM55:
.LFBB13:
	SUB	sp,#4
	.stabn	68,0,170,.LM56-.LFBB13
.LM56:
	LD	r5,#1073751808
	LD.w	r5,[r5+#12]
	ST.w	[sp],r5
	.stabn	68,0,172,.LM57-.LFBB13
.LM57:
	LD.w	r5,[sp]
	.stabn	68,0,173,.LM58-.LFBB13
.LM58:
	MOV	r0,r5
	ADD	sp,#4
	JMP	lr
	.size	GET_AES_OUTPUT0_DATA, .-GET_AES_OUTPUT0_DATA
	.stabs	"DATA:(3,6)",128,0,169,0
...
.Lscope13:
	...
	.align	1
	.stabs	"GET_AES_OUTPUT1_DATA:F(3,6)",36,0,175,GET_AES_OUTPUT1_DATA
	.export	GET_AES_OUTPUT1_DATA
	.type	GET_AES_OUTPUT1_DATA, @function
GET_AES_OUTPUT1_DATA:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_aes.c",132,0,0,.Ltext14
.Ltext14:
	.stabn	68,0,176,.LM59-.LFBB14
.LM59:
.LFBB14:
	SUB	sp,#4
	.stabn	68,0,178,.LM60-.LFBB14
.LM60:
	LD	r5,#1073751808
	LD.w	r5,[r5+#13]
	ST.w	[sp],r5
	.stabn	68,0,180,.LM61-.LFBB14
.LM61:
	LD.w	r5,[sp]
	.stabn	68,0,181,.LM62-.LFBB14
.LM62:
	MOV	r0,r5
	ADD	sp,#4
	JMP	lr
	.size	GET_AES_OUTPUT1_DATA, .-GET_AES_OUTPUT1_DATA
	.stabs	"DATA:(3,6)",128,0,177,0
...
.Lscope14:
	...
	.align	1
	.stabs	"GET_AES_OUTPUT2_DATA:F(3,6)",36,0,183,GET_AES_OUTPUT2_DATA
	.export	GET_AES_OUTPUT2_DATA
	.type	GET_AES_OUTPUT2_DATA, @function
GET_AES_OUTPUT2_DATA:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_aes.c",132,0,0,.Ltext15
.Ltext15:
	.stabn	68,0,184,.LM63-.LFBB15
.LM63:
.LFBB15:
	SUB	sp,#4
	.stabn	68,0,186,.LM64-.LFBB15
.LM64:
	LD	r5,#1073751808
	LD.w	r5,[r5+#14]
	ST.w	[sp],r5
	.stabn	68,0,188,.LM65-.LFBB15
.LM65:
	LD.w	r5,[sp]
	.stabn	68,0,189,.LM66-.LFBB15
.LM66:
	MOV	r0,r5
	ADD	sp,#4
	JMP	lr
	.size	GET_AES_OUTPUT2_DATA, .-GET_AES_OUTPUT2_DATA
	.stabs	"DATA:(3,6)",128,0,185,0
...
.Lscope15:
	...
	.align	1
	.stabs	"GET_AES_OUTPUT3_DATA:F(3,6)",36,0,191,GET_AES_OUTPUT3_DATA
	.export	GET_AES_OUTPUT3_DATA
	.type	GET_AES_OUTPUT3_DATA, @function
GET_AES_OUTPUT3_DATA:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_aes.c",132,0,0,.Ltext16
.Ltext16:
	.stabn	68,0,192,.LM67-.LFBB16
.LM67:
.LFBB16:
	SUB	sp,#4
	.stabn	68,0,194,.LM68-.LFBB16
.LM68:
	LD	r5,#1073751808
	LD.w	r5,[r5+#15]
	ST.w	[sp],r5
	.stabn	68,0,196,.LM69-.LFBB16
.LM69:
	LD.w	r5,[sp]
	.stabn	68,0,197,.LM70-.LFBB16
.LM70:
	MOV	r0,r5
	ADD	sp,#4
	JMP	lr
	.size	GET_AES_OUTPUT3_DATA, .-GET_AES_OUTPUT3_DATA
	.stabs	"DATA:(3,6)",128,0,193,0
...
.Lscope16:
	...
	.align	1
	.stabs	"AES_Get_Flag_Status:F(2,4)",36,0,200,AES_Get_Flag_Status
	.export	AES_Get_Flag_Status
	.type	AES_Get_Flag_Status, @function
AES_Get_Flag_Status:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_aes.c",132,0,0,.Ltext17
.Ltext17:
	.stabn	68,0,201,.LM71-.LFBB17
.LM71:
.LFBB17:
	.stabn	68,0,202,.LM72-.LFBB17
.LM72:
	LD	r5,#1073751808
	LD.w	r5,[r5]
	CMP	r5,#0
	JPL	.L23
	.stabn	68,0,205,.LM73-.LFBB17
.LM73:
	MOV	r5,#1
	JMP	.L24
.L23:
	.stabn	68,0,210,.LM74-.LFBB17
.LM74:
	MOV	r5,#0
.L24:
	.stabn	68,0,212,.LM75-.LFBB17
.LM75:
	MOV	r0,r5
	JMP	lr
...
.Lscope17:
	...
	.align	1
	.stabs	"AES_Start:F(0,15)",36,0,220,AES_Start
	.export	AES_Start
	.type	AES_Start, @function
AES_Start:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_aes.c",132,0,0,.Ltext18
.Ltext18:
	.stabn	68,0,221,.LM76-.LFBB18
.LM76:
.LFBB18:
	.stabn	68,0,223,.LM77-.LFBB18
.LM77:
	LD	r4,#1073751808
	LD	r5,#1073751808
	LD.w	r5,[r5]
...
.Lscope18:
	...
	.align	1
	.stabs	"AES_CLR_Flag_Status:F(0,15)",36,0,233,AES_CLR_Flag_Status
	.export	AES_CLR_Flag_Status
	.type	AES_CLR_Flag_Status, @function
AES_CLR_Flag_Status:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_aes.c",132,0,0,.Ltext19
.Ltext19:
	.stabn	68,0,234,.LM79-.LFBB19
.LM79:
.LFBB19:
	PUSH	lr
	.stabn	68,0,236,.LM80-.LFBB19
.LM80:
	LD	r4,#1073751808
	LD	r5,#1073751808
	LD.w	r5,[r5]
	SET	r5,#23
	ST.w	[r4],r5
	.stabn	68,0,237,.LM81-.LFBB19
.LM81:
	NOP
.L27:
	LD	r5,#AES_Get_Flag_Status
	LJMP	r5
	MOV	r5,r0
	CMP	r5,#0
	JNZ	.L27
	.stabn	68,0,238,.LM82-.LFBB19
.LM82:
	LD	r4,#1073751808
	LD	r5,#1073751808
	LD.w	r5,[r5]
