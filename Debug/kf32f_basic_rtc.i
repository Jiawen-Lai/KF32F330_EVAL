...
RTC_Start_Config (void)
{
    ...
    tmpreg = 0x55 << (8);
    (((RTC_SFRmap *) ((uint32_t)0x40000F00))->CR) = SFR_Config ((((RTC_SFRmap *) ((uint32_t)0x40000F00))->CR), ~((uint32_t)0xFF<<((8))), tmpreg);
}
