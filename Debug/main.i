...
uint32_t delay() __attribute__ ((warn_unused_result));

uint32_t delay()
{
 volatile uint32_t i =0x2fffff;
 while( i--);
 return i;
}
...
void main()
{
 ...
 USART_Async_config(((USART_SFRmap *) ((uint32_t)0x40000A80)));

 ((USART_SFRmap *) ((uint32_t)0x40000A80))->CTLR |= 0x40000000;



 unsigned char FLASH_BUFFER[1024] ={0};
 ...
 GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x500000C0)) , ((uint16_t)0x0040), GPIO_MODE_IN );
 GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)) , ((uint16_t)0x0100)|((uint16_t)0x0200)|((uint16_t)0x0400)|((uint16_t)0x0800)|((uint16_t)0x1000)|((uint16_t)0x2000), GPIO_MODE_OUT );
# 72 "../main.c"
 GPIO_Toggle_Output_Data_Config(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0100));
 ...
 USART_Send(((USART_SFRmap *) ((uint32_t)0x40000A80)) , "Initing\r\n" ,sizeof("Initing\r\n"));

 while(1)
 {
  if(GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x500000C0)) , ((uint16_t)0x0040)))
  {
   sz= Ymodem_Receive(tab_133);

   if(sz >99)
    GPIO_Toggle_Output_Data_Config(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0100));
  }

  if(*(volatile uint32_t*)0x8000 == 0x10020000 )
  {

        (((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->VECTOFF) = 0x8000 ;

        JumpAddress = *(volatile uint32_t*) (0x8000 + 4);
  ...
  USART_Send(((USART_SFRmap *) ((uint32_t)0x40000A80)) , "hello 2020\r\n" ,sizeof("hello 2020\r\n"));



  GPIO_Toggle_Output_Data_Config(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0400));
