	...
	.stabs	"../src/kf32f_basic_rst.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.stabs	"D:\\workspace32\\KF32Fxxx_StdPeriph_Lib_V2.3\\inc/kf32f_basic_rst.h",130,0,0,0
	...
	.align	1
	.stabs	"RST_CTL0_Peripheral_Reset_Enable:F(0,15)",36,0,35,RST_CTL0_Peripheral_Reset_Enable
	.stabs	"RST_CTL0_bit:p(3,6)",160,0,35,0
	.stabs	"NewState:p(2,2)",160,0,36,4
	.export	RST_CTL0_Peripheral_Reset_Enable
	.type	RST_CTL0_Peripheral_Reset_Enable, @function
RST_CTL0_Peripheral_Reset_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_rst.c",132,0,0,.Ltext1
.Ltext1:
...
.Lscope1:
	...
	.align	1
	.stabs	"RST_CTL1_Peripheral_Reset_Enable:F(0,15)",36,0,87,RST_CTL1_Peripheral_Reset_Enable
	.stabs	"RST_CTL1_bit:p(3,6)",160,0,87,0
	.stabs	"NewState:p(2,2)",160,0,88,4
	.export	RST_CTL1_Peripheral_Reset_Enable
	.type	RST_CTL1_Peripheral_Reset_Enable, @function
RST_CTL1_Peripheral_Reset_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_rst.c",132,0,0,.Ltext2
.Ltext2:
	.stabn	68,0,89,.LM5-.LFBB2
.LM5:
.LFBB2:
	SUB	sp,#8
	ST.w	[sp],r0
	ST.w	[sp+#1],r1
	.stabn	68,0,94,.LM6-.LFBB2
.LM6:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L5
	.stabn	68,0,96,.LM7-.LFBB2
.LM7:
	LD	r5,#1073747200
	LD	r4,#1073747200
	LD.w	r3,[r4+#1]
...
.Lscope2:
	...
	.align	1
	.stabs	"RST_CTL2_Peripheral_Reset_Enable:F(0,15)",36,0,129,RST_CTL2_Peripheral_Reset_Enable
	.stabs	"RST_CTL2_bit:p(3,6)",160,0,129,0
	.stabs	"NewState:p(2,2)",160,0,130,4
	.export	RST_CTL2_Peripheral_Reset_Enable
	.type	RST_CTL2_Peripheral_Reset_Enable, @function
RST_CTL2_Peripheral_Reset_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_rst.c",132,0,0,.Ltext3
.Ltext3:
	.stabn	68,0,131,.LM10-.LFBB3
.LM10:
.LFBB3:
	SUB	sp,#8
	ST.w	[sp],r0
	ST.w	[sp+#1],r1
	.stabn	68,0,136,.LM11-.LFBB3
.LM11:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L8
	.stabn	68,0,138,.LM12-.LFBB3
.LM12:
	LD	r5,#1073747200
	LD	r4,#1073747200
	LD.w	r3,[r4+#2]
...
.Lscope3:
	...
	.align	1
	.stabs	"RST_CTL3_Peripheral_Reset_Enable:F(0,15)",36,0,164,RST_CTL3_Peripheral_Reset_Enable
	.stabs	"RST_CTL3_bit:p(3,6)",160,0,164,0
	.stabs	"NewState:p(2,2)",160,0,165,4
	.export	RST_CTL3_Peripheral_Reset_Enable
	.type	RST_CTL3_Peripheral_Reset_Enable, @function
RST_CTL3_Peripheral_Reset_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_rst.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,166,.LM15-.LFBB4
.LM15:
.LFBB4:
	SUB	sp,#8
	ST.w	[sp],r0
	ST.w	[sp+#1],r1
	.stabn	68,0,171,.LM16-.LFBB4
.LM16:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L11
	.stabn	68,0,173,.LM17-.LFBB4
.LM17:
	LD	r5,#1073747200
	LD	r4,#1073747200
	LD.w	r3,[r4+#3]
