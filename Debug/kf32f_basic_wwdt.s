	...
	.stabs	"../src/kf32f_basic_wwdt.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.stabs	"D:\\workspace32\\KF32Fxxx_StdPeriph_Lib_V2.3\\inc/kf32f_basic_wwdt.h",130,0,0,0
...
.Lscope1:
	...
	.align	1
	.stabs	"WWDT_Reset:F(0,15)",36,0,28,WWDT_Reset
	.export	WWDT_Reset
	.type	WWDT_Reset, @function
WWDT_Reset:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_wwdt.c",132,0,0,.Ltext2
.Ltext2:
...
.LM5:
	...
	LD	r5,#RST_CTL2_Peripheral_Reset_Enable
	LJMP	r5
	.stabn	68,0,35,.LM6-.LFBB2
.LM6:
	MOV	r0,#32
	MOV	r1,#1
	LD	r5,#PCLK_CTL2_Peripheral_Clock_Enable
	LJMP	r5
	.stabn	68,0,36,.LM7-.LFBB2
.LM7:
	POP	lr
	JMP	lr
...
.Lscope2:
	...
	.align	1
	.stabs	"WWDT_Threshold_Config:F(0,15)",36,0,44,WWDT_Threshold_Config
	.stabs	"Threshold:p(3,6)",160,0,44,4
	.export	WWDT_Threshold_Config
	.type	WWDT_Threshold_Config, @function
WWDT_Threshold_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_wwdt.c",132,0,0,.Ltext3
.Ltext3:
	.stabn	68,0,45,.LM8-.LFBB3
.LM8:
.LFBB3:
	PUSH	{r6, lr}
	SUB	sp,#8
	ST.w	[sp+#1],r0
	.stabn	68,0,46,.LM9-.LFBB3
.LM9:
	MOV	r5,#0
	ST.w	[sp],r5
...
.Lscope3:
	...
	.align	1
	.stabs	"WWDT_Prescaler_Config:F(0,15)",36,0,81,WWDT_Prescaler_Config
	.stabs	"Prescaler:p(3,6)",160,0,81,0
	.export	WWDT_Prescaler_Config
	.type	WWDT_Prescaler_Config, @function
WWDT_Prescaler_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_wwdt.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,82,.LM13-.LFBB4
.LM13:
.LFBB4:
	PUSH	{r6, lr}
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,87,.LM14-.LFBB4
.LM14:
	LD	r6,#1073746560
	LD	r5,#1073746560
	LD.w	r5,[r5]
...
.Lscope4:
	...
	.align	1
	.stabs	"WWDT_Enable:F(0,15)",36,0,96,WWDT_Enable
	.stabs	"NewState:p(2,2)",160,0,96,0
	.export	WWDT_Enable
	.type	WWDT_Enable, @function
WWDT_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_wwdt.c",132,0,0,.Ltext5
.Ltext5:
	.stabn	68,0,97,.LM16-.LFBB5
.LM16:
.LFBB5:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,102,.LM17-.LFBB5
.LM17:
	LD.w	r5,[sp]
	CMP	r5,#0
	JZ	.L7
	.stabn	68,0,105,.LM18-.LFBB5
.LM18:
	LD	r5,#1073746560
// inline asm begin
...
.Lscope5:
	...
	.align	1
	.stabs	"WWDT_Counter_Config:F(0,15)",36,0,120,WWDT_Counter_Config
	.stabs	"Counter:p(3,6)",160,0,120,0
	.export	WWDT_Counter_Config
	.type	WWDT_Counter_Config, @function
WWDT_Counter_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_wwdt.c",132,0,0,.Ltext6
.Ltext6:
	.stabn	68,0,121,.LM21-.LFBB6
.LM21:
.LFBB6:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,126,.LM22-.LFBB6
.LM22:
	LD	r5,#1073746560
	LD.w	r4,[sp]
	ST.w	[r5+#1],r4
	.stabn	68,0,127,.LM23-.LFBB6
.LM23:
	ADD	sp,#4
	JMP	lr
...
.Lscope6:
	...
	.align	1
	.stabs	"WWDT_Get_Counter:F(3,6)",36,0,135,WWDT_Get_Counter
	.export	WWDT_Get_Counter
	.type	WWDT_Get_Counter, @function
WWDT_Get_Counter:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_wwdt.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,136,.LM24-.LFBB7
.LM24:
.LFBB7:
	SUB	sp,#4
	.stabn	68,0,137,.LM25-.LFBB7
.LM25:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,140,.LM26-.LFBB7
.LM26:
	LD	r5,#1073746560
	LD.w	r4,[r5+#1]
	MOV	r5,#127
	ANL	r5,r4,r5
	ST.w	[sp],r5
	.stabn	68,0,143,.LM27-.LFBB7
.LM27:
	LD.w	r5,[sp]
	.stabn	68,0,144,.LM28-.LFBB7
.LM28:
	MOV	r0,r5
	ADD	sp,#4
	JMP	lr
	.size	WWDT_Get_Counter, .-WWDT_Get_Counter
	.stabs	"tmpreg:(3,6)",128,0,137,0
...
.Lscope7:
	...
	.align	1
	.stabs	"WWDT_INT_Enable:F(0,15)",36,0,159,WWDT_INT_Enable
	.stabs	"NewState:p(2,2)",160,0,159,0
	.export	WWDT_INT_Enable
	.type	WWDT_INT_Enable, @function
WWDT_INT_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_wwdt.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,160,.LM29-.LFBB8
.LM29:
.LFBB8:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,165,.LM30-.LFBB8
.LM30:
	LD.w	r5,[sp]
	CMP	r5,#0
	JZ	.L13
...
.Lscope8:
	...
	.align	1
	.stabs	"WWDT_Get_INT_Flag:F(2,4)",36,0,183,WWDT_Get_INT_Flag
	.export	WWDT_Get_INT_Flag
	.type	WWDT_Get_INT_Flag, @function
WWDT_Get_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_wwdt.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,184,.LM34-.LFBB9
.LM34:
.LFBB9:
	.stabn	68,0,186,.LM35-.LFBB9
.LM35:
	LD	r5,#1073746560
	LD.w	r4,[r5]
	MOV	r5,#4
	...
	CMP	r5,#0
	JZ	.L16
	.stabn	68,0,189,.LM36-.LFBB9
.LM36:
	MOV	r5,#1
	JMP	.L17
.L16:
	.stabn	68,0,194,.LM37-.LFBB9
.LM37:
	MOV	r5,#0
.L17:
	.stabn	68,0,196,.LM38-.LFBB9
.LM38:
	MOV	r0,r5
	JMP	lr
...
.Lscope9:
	...
	.align	1
	.stabs	"WWDT_Clear_INT_Flag:F(0,15)",36,0,204,WWDT_Clear_INT_Flag
	.export	WWDT_Clear_INT_Flag
	.type	WWDT_Clear_INT_Flag, @function
WWDT_Clear_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_wwdt.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,205,.LM39-.LFBB10
.LM39:
.LFBB10:
	.stabn	68,0,207,.LM40-.LFBB10
.LM40:
	LD	r5,#1073746560
// inline asm begin
	// 207 "../src/kf32f_basic_wwdt.c" 1
	SET [r5], #15
	.stabn	68,0,208,.LM41-.LFBB10
.LM41:
// inline asm end
	NOP
.L19:
	...
	CMP	r5,#0
	JNZ	.L19
	.stabn	68,0,209,.LM42-.LFBB10
.LM42:
	LD	r5,#1073746560
// inline asm begin
	// 209 "../src/kf32f_basic_wwdt.c" 1
	CLR [r5], #15
	.stabn	68,0,210,.LM43-.LFBB10
.LM43:
// inline asm end
	JMP	lr
