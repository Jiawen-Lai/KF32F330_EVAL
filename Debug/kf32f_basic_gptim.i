...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 19 "../src/kf32f_basic_gptim.c" 2
# 56 "../src/kf32f_basic_gptim.c"
void GPTIM_Configuration(GPTIM_SFRmap* GPTIMx,
                    GPTIM_InitTypeDef* gptimInitStruct)
{
    uint32_t tmpreg = 0;
    ...
    if ((GPTIMx == ((GPTIM_SFRmap *) ((uint32_t)0x40001B80))) || (GPTIMx == ((GPTIM_SFRmap *) ((uint32_t)0x40001C00))))
    {
...
GPTIM_Clear_Overflow_INT_Flag (GPTIM_SFRmap* GPTIMx)
{
    ...
    while((GPTIMx->CTL1 & ((uint32_t)1<<((13))))>>(13));
    __asm volatile("CLR [%0], #%1"::"r"(&(GPTIMx->CCPXSRIC)),"i"((6)));
}
# 923 "../src/kf32f_basic_gptim.c"
void
GPTIM_Clear_Updata_INT_Flag (GPTIM_SFRmap* GPTIMx)
{
    ...
    while((GPTIMx->CCPXEGIF & ((uint32_t)1<<((11))))>>(11));
    __asm volatile("CLR [%0], #%1"::"r"(&(GPTIMx->CCPXSRIC)),"i"((5)));
}
# 944 "../src/kf32f_basic_gptim.c"
void
GPTIM_Clear_Trigger_INT_Flag (GPTIM_SFRmap* GPTIMx)
{
    ...
    while((GPTIMx->CCPXEGIF & ((uint32_t)1<<((10))))>>(10));
    __asm volatile("CLR [%0], #%1"::"r"(&(GPTIMx->CCPXSRIC)),"i"((4)));
}
# 965 "../src/kf32f_basic_gptim.c"
FlagStatus
                    ...
                    CCP_CompareInitTypeDef* ccpInitStruct)
{
    ...
    if ((CCPx == ((CCP_SFRmap *) ((uint32_t)0x40001B80))) || (CCPx == ((CCP_SFRmap *) ((uint32_t)0x40001C00))))
    {
...
CCP_Clear_Channel_INT_Flag (CCP_SFRmap* CCPx, uint32_t Channel)
{
 uint32_t tmpreg = 0;
    ...
    while((CCPx->CCPXEGIF & tmpreg)>>(Channel+(6)));
    CCPx->CCPXSRIC &= ~(((uint32_t)1<<((0))) << Channel);
}
