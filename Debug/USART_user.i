...
void GPIO_USART()
{
 GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)) ,((uint16_t)0x4000), GPIO_MODE_RMP);
 GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)) ,((uint16_t)0x8000), GPIO_MODE_RMP);
 GPIO_Pin_RMP_Config (((GPIO_SFRmap *) ((uint32_t)0x50000040)), ((uint32_t)0xE), ((uint8_t)0x05));
 GPIO_Pin_RMP_Config (((GPIO_SFRmap *) ((uint32_t)0x50000040)), ((uint32_t)0xF), ((uint8_t)0x05));
 GPIO_Pin_Lock_Config (((GPIO_SFRmap *) ((uint32_t)0x50000040)) ,((uint16_t)0x8000), TRUE);
 GPIO_Pin_Lock_Config (((GPIO_SFRmap *) ((uint32_t)0x50000040)) ,((uint16_t)0x4000), TRUE);
}
# 37 "../USART_user.c"
void USART_Send(USART_SFRmap* USARTx, uint8_t* Databuf, uint32_t length)
{
