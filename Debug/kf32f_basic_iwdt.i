...
# 15 "D:\\workspace32\\KF32Fxxx_StdPeriph_Lib_V2.3\\inc/kf32f_basic_iwdt.h" 2
...
# 14 "../src/kf32f_basic_iwdt.c" 2
# 39 "../src/kf32f_basic_iwdt.c"
void
IWDT_Prescaler_Config (uint32_t Prescaler)
{
    ...
    (((IWDT_SFRmap *) ((uint32_t)0x40001200))->CTL) = SFR_Config ((((IWDT_SFRmap *) ((uint32_t)0x40001200))->CTL), ~((uint32_t)0xF<<((0))), Prescaler);
}
...
IWDT_Overflow_Config (uint32_t Overflow)
{
    ...
    tmpreg = Overflow << (4);
    (((IWDT_SFRmap *) ((uint32_t)0x40001200))->CTL) = SFR_Config ((((IWDT_SFRmap *) ((uint32_t)0x40001200))->CTL), ~((uint32_t)0xFFF<<((4))), tmpreg);
}
...
IWDT_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((IWDT_SFRmap *) ((uint32_t)0x40001200))->CTL))),"i"((31)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((IWDT_SFRmap *) ((uint32_t)0x40001200))->CTL))),"i"((31)));
    }
}
...
{
    (((IWDT_SFRmap *) ((uint32_t)0x40001200))->FD) = ((uint32_t)0x55AA55AA);
}
