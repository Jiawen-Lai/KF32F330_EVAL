...
# 15 "D:\\workspace32\\KF32Fxxx_StdPeriph_Lib_V2.3\\inc/kf32f_basic_bkp.h" 2
...
# 16 "../src/kf32f_basic_bkp.c" 2
# 26 "../src/kf32f_basic_bkp.c"
void
BKP_Reset (void)
{

    __asm volatile("SET [%0], #%1"::"r"(&((((BKP_SFRmap *) ((uint32_t)0x40001400))->CTL))),"i"((31)));
    __asm volatile("CLR [%0], #%1"::"r"(&((((BKP_SFRmap *) ((uint32_t)0x40001400))->CTL))),"i"((31)));
}
# 45 "../src/kf32f_basic_bkp.c"
void
BKP_Write_And_Read_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        tmpreg = (((OSC_SFRmap *) ((uint32_t)0x40000000))->CTL0);
        if (((uint32_t)1<<((0))) & tmpreg)
        {
            pmwrenbkp = TRUE;
        }
        else
        ...
        tmpreg = (((PM_SFRmap *) ((uint32_t)0x40001580))->CTL0);
        if (((uint32_t)1<<((22))) & tmpreg)
        {
            bkpregclrbkp = TRUE;
        }
        else
...
BKP_Pin_Effective_Level_Config (uint32_t PinSel, uint32_t Effective)
{
    ...
    tmpreg = ((uint32_t)1<<((20))) << PinSel;
    if (((uint32_t)0) != Effective)
    {

        (((BKP_SFRmap *) ((uint32_t)0x40001400))->CTL) |= tmpreg;
    }
    else
    {
...
BKP_RTC_Clock_Config (uint32_t Source)
{
    ...
    (((BKP_SFRmap *) ((uint32_t)0x40001400))->CTL) = SFR_Config ((((BKP_SFRmap *) ((uint32_t)0x40001400))->CTL), ~((uint32_t)3<<((8))), Source);
}
# 263 "../src/kf32f_basic_bkp.c"
void
...
BKP_Data_Config (uint32_t OrderNumber, uint32_t WriteData)
{
    ...
    ((BKP_SFRmap *) ((uint32_t)0x40001400))->DATA[OrderNumber] = WriteData;
}
...
BKP_Get_Data (uint32_t OrderNumber)
{
    ...
    tmpreg = ((BKP_SFRmap *) ((uint32_t)0x40001400))->DATA[OrderNumber];

    return tmpreg;
}
# 337 "../src/kf32f_basic_bkp.c"
void
BKP_Pin_TAMP_INT_Enable (uint32_t PinSel, FunctionalState NewState)
{
    ...
    tmpreg = ((uint32_t)1<<((8))) << PinSel;
    if (NewState != FALSE)
    {

        (((BKP_SFRmap *) ((uint32_t)0x40001400))->INT) |= tmpreg;
    }
    else
    {
...
BKP_Get_Pin_TAMP_INT_Flag (uint32_t PinSel)
{
    ...
    tmpreg = ((uint32_t)1<<((16))) << PinSel;
    if ((((BKP_SFRmap *) ((uint32_t)0x40001400))->INT) & tmpreg)
    {
...
BKP_Clear_Pin_TAMP_INT_Flag (uint32_t PinSel)
{
    ...
    tmpreg = ((uint32_t)1<<((0))) << PinSel;
    tmpreg1 = ((uint32_t)1<<((16))) << PinSel;
    (((BKP_SFRmap *) ((uint32_t)0x40001400))->INT) |= tmpreg;
    while(((((BKP_SFRmap *) ((uint32_t)0x40001400))->INT) & tmpreg1)>>((16)+PinSel));
    (((BKP_SFRmap *) ((uint32_t)0x40001400))->INT) &= ~tmpreg;
}
