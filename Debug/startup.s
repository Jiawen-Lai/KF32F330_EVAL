	...
	.stabs	"../config/startup.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.align	2
	.stabs	"startup:F(0,15)",36,0,7,startup
	.export	startup
	.type	startup, @function
startup:
	.stabd	46,0,0
	.stabs	"../config/startup.c",132,0,0,.Ltext1
.Ltext1:
...
.LM11:
	...
	CMP	r4,r5
	JHI	.L5
	.stabn	68,0,21,.LM12-.LFBB1
.LM12:
	LD	r5,#main
	LJMP	r5
	.stabn	68,0,22,.LM13-.LFBB1
.LM13:
	ADD	sp,#12
	POP	lr
	JMP	lr
	.size	startup, .-startup
	.stabs	"s:(0,16)=*(0,4)",128,0,10,0
	.stabs	"begin:(0,16)",128,0,10,4
	.stabs	"end:(0,16)",128,0,10,8
