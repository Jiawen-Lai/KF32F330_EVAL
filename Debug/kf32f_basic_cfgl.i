...
# 14 "D:\\workspace32\\KF32Fxxx_StdPeriph_Lib_V2.3\\inc/kf32f_basic_cfgl.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 17 "../src/kf32f_basic_cfgl.c" 2
# 48 "../src/kf32f_basic_cfgl.c"
void
CFGL_Reset ()
{

 RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((19))), TRUE);
 RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((19))), FALSE);
 PCLK_CTL3_Peripheral_Clock_Enable(((uint32_t)1<<((19))), TRUE);
...
# 104 "../src/kf32f_basic_cfgl.c"
    ...
    CFGLx->CTL0 = SFR_Config (CFGLx->CTL0, ~(((uint32_t)1<<((31))) | ((uint32_t)1<<((30))) | ((uint32_t)1<<((29))) | ((uint32_t)1<<((28))) | ((uint32_t)7<<((25))) | ((uint32_t)1<<((24))) | ((uint32_t)1<<((23))) | ((uint32_t)1<<((22))) | ((uint32_t)1<<((21))) | ((uint32_t)1<<((20))) | ((uint32_t)7<<((16))) | ((uint32_t)7<<((12))) | ((uint32_t)7<<((8))) | ((uint32_t)7<<((4))) | ((uint32_t)1<<((3))) | ((uint32_t)7<<((0)))), tmpreg);
# 155 "../src/kf32f_basic_cfgl.c"
    tmpreg = (uint32_t)((CFGLInitStruct->m_G4D4_Inphase_EN << (31)) |
         (CFGLInitStruct->m_G4D4_Inverse_EN << (30)) |
         (CFGLInitStruct->m_G4D3_Inphase_EN << (29)) |
         (CFGLInitStruct->m_G4D3_Inverse_EN << (28)) |
         (CFGLInitStruct->m_G4D2_Inphase_EN << (27)) |
         (CFGLInitStruct->m_G4D2_Inverse_EN << (26)) |
         (CFGLInitStruct->m_G4D1_Inphase_EN << (25)) |
         (CFGLInitStruct->m_G4D1_Inverse_EN << (24)) |
         (CFGLInitStruct->m_G3D4_Inphase_EN << (23)) |
      (CFGLInitStruct->m_G3D4_Inverse_EN << (22)) |
      (CFGLInitStruct->m_G3D3_Inphase_EN << (21)) |
      (CFGLInitStruct->m_G3D3_Inverse_EN << (20)) |
      (CFGLInitStruct->m_G3D2_Inphase_EN << (19)) |
      (CFGLInitStruct->m_G3D2_Inverse_EN << (18)) |
      (CFGLInitStruct->m_G3D1_Inphase_EN << (17)) |
      (CFGLInitStruct->m_G3D1_Inverse_EN << (16)) |
         (CFGLInitStruct->m_G2D4_Inphase_EN << (15)) |
      (CFGLInitStruct->m_G2D4_Inverse_EN << (14)) |
      (CFGLInitStruct->m_G2D3_Inphase_EN << (13)) |
      (CFGLInitStruct->m_G2D3_Inverse_EN << (12)) |
      (CFGLInitStruct->m_G2D2_Inphase_EN << (11)) |
      (CFGLInitStruct->m_G2D2_Inverse_EN << (10)) |
      (CFGLInitStruct->m_G2D1_Inphase_EN << (9)) |
      (CFGLInitStruct->m_G2D1_Inverse_EN << (8)) |
         (CFGLInitStruct->m_G1D4_Inphase_EN << (7)) |
      (CFGLInitStruct->m_G1D4_Inverse_EN << (6)) |
      (CFGLInitStruct->m_G1D3_Inphase_EN << (5)) |
      (CFGLInitStruct->m_G1D3_Inverse_EN << (4)) |
      (CFGLInitStruct->m_G1D2_Inphase_EN << (3)) |
      (CFGLInitStruct->m_G1D2_Inverse_EN << (2)) |
      (CFGLInitStruct->m_G1D1_Inphase_EN << (1)) |
      (CFGLInitStruct->m_G1D1_Inverse_EN << (0)));
    CFGLx->CTL1 = SFR_Config (CFGLx->CTL1, ~0XFFFFFFFF, tmpreg);
...
CFGL_Struct_Init (CFGL_InitTypeDef* CFGLInitStruct)
{
 ...
 CFGLInitStruct->m_Module_EN = ((uint32_t) 0x0 << (31));

    CFGLInitStruct->m_Output_EN = ((uint32_t) 0x0 << (30));

    CFGLInitStruct->m_RaiseINT_EN = ((uint32_t) 0x0 << (29));

    CFGLInitStruct->m_FallINT_EN = ((uint32_t) 0x0 << (28));

    CFGLInitStruct->m_Mode_Sel = ((uint32_t) 0x0 << (25));

    CFGLInitStruct->m_Output_Pol = ((uint32_t) 0x0 << (24));

 CFGLInitStruct->m_G4Output_POL = ((uint32_t) 0x0 << (23));

    CFGLInitStruct->m_G3Output_POL = ((uint32_t) 0x0 << (22));

    CFGLInitStruct->m_G2Output_POL = ((uint32_t) 0x0 << (21));

    CFGLInitStruct->m_G1Output_POL = ((uint32_t) 0x0 << (20));

    CFGLInitStruct->m_G4Input_Sel = ((uint32_t) 0x7 << (16));

    CFGLInitStruct->m_G3Input_Sel = ((uint32_t) 0x7 << (12));

    CFGLInitStruct->m_G2Input_Sel = ((uint32_t) 0x7 << (8));

    CFGLInitStruct->m_G1Input_Sel = ((uint32_t) 0x7 << (4));

    CFGLInitStruct->m_CH4Data_Sel = ((uint32_t) 0x0 << (3));

    CFGLInitStruct->m_CH5CH6Data_Sel = ((uint32_t) 0x7 << (0));
...
CFGL2_OUT_SYNCHRO_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
     ...
     __asm volatile("SET [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR)),"i"((31)));

    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR)),"i"((31)));
    }
}
...
CFGL1_OUT_SYNCHRO_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
     ...
     __asm volatile("SET [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR)),"i"((30)));

    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR)),"i"((30)));
    }
}
...
CFGL2_FALLINT_Enable (FunctionalState NewState)
{
 ...
 ((void)0);
    ...
    if (NewState != FALSE)
    {
     ...
     __asm volatile("SET [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002988))->CTL0)),"i"((28)));
     __asm volatile("SET [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR)),"i"((29)));

    }
    else
    {

     __asm volatile("CLR [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002988))->CTL0)),"i"((28)));
        __asm volatile("CLR [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR)),"i"((29)));
    }
}
...
CFGL2_RISEINT_Enable (FunctionalState NewState)
{
 ...
 ((void)0);
    ...
    if (NewState != FALSE)
    {
     ...
     __asm volatile("SET [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002988))->CTL0)),"i"((29)));
     __asm volatile("SET [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR)),"i"((29)));
    ...
    else
    {
     ...
     __asm volatile("CLR [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002988))->CTL0)),"i"((29)));
        __asm volatile("CLR [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR)),"i"((29)));
    }
}
...
CFGL1_FALLINT_Enable (FunctionalState NewState)
{
 ...
 ((void)0);
    ...
    if (NewState != FALSE)
    {
     ...
     __asm volatile("SET [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002980))->CTL0)),"i"((28)));
     __asm volatile("SET [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR)),"i"((28)));

    }
    else
    {

     __asm volatile("CLR [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002980))->CTL0)),"i"((28)));
        __asm volatile("CLR [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR)),"i"((28)));
    }
}
...
CFGL1_RISEINT_Enable (FunctionalState NewState)
{
 ...
 ((void)0);
    ...
    if (NewState != FALSE)
    {
     ...
     __asm volatile("SET [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002980))->CTL0)),"i"((29)));
     __asm volatile("SET [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR)),"i"((28)));
    ...
    else
    {
     ...
     __asm volatile("CLR [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002980))->CTL0)),"i"((29)));
        __asm volatile("CLR [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR)),"i"((28)));
    }
}
...
CFGL1_Get_INT_Flag ()
{
    ...
    if (((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR & ((uint32_t)1<<((8))))
    {
...
CFGL2_Get_INT_Flag ()
{
    ...
    if (((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR & ((uint32_t)1<<((9))))
    {
...
CFGL1_Clear_RISEINT_Flag (void)
{
 ...
 __asm volatile("CLR [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002980))->CTL0)),"i"((29)));
 while((((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR & ((uint32_t)1<<((8))))>>(8));
 __asm volatile("SET [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002980))->CTL0)),"i"((29)));
}
...
CFGL2_Clear_RISEINT_Flag (void)
{
 ...
 __asm volatile("CLR [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002988))->CTL0)),"i"((29)));
 while((((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR & ((uint32_t)1<<((9))))>>(9));
 __asm volatile("SET [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002988))->CTL0)),"i"((29)));
}
...
CFGL2_OUT_STATE ()
{
    ...
    if (((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR & ((uint32_t)1<<((1))))
    {
...
CFGL1_OUT_STATE ()
{
    ...
    if (((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR & ((uint32_t)1<<((0))))
    {
