...
# 15 "D:\\workspace32\\KF32Fxxx_StdPeriph_Lib_V2.3\\inc/kf32f_basic_sysctl.h" 2
...
# 15 "../src/kf32f_basic_sysctl.c" 2
# 30 "../src/kf32f_basic_sysctl.c"
FlagStatus
SYSCTL_Get_V_Flag (void)
{

    if ((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->PSW) & ((uint32_t)1<<((28))))
    {
...
SYSCTL_Get_C_Flag (void)
{
    ...
    if ((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->PSW) & ((uint32_t)1<<((29))))
    {
...
SYSCTL_Get_Z_Flag (void)
{
    ...
    if ((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->PSW) & ((uint32_t)1<<((30))))
    {
...
SYSCTL_Get_N_Flag (void)
{
    ...
    if ((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->PSW) & ((uint32_t)1<<((31))))
    {
...
SYSCTL_Set_V_Flag (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->PSW))),"i"((28)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->PSW))),"i"((28)));
    }
}
...
SYSCTL_Set_C_Flag (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->PSW))),"i"((29)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->PSW))),"i"((29)));
    }
}
...
SYSCTL_Set_Z_Flag (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->PSW))),"i"((30)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->PSW))),"i"((30)));
    }
}
...
SYSCTL_Set_N_Flag (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->PSW))),"i"((31)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->PSW))),"i"((31)));
    }
}
...
SYSCTL_Sleep_On_Exit_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->MCTL))),"i"((1)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->MCTL))),"i"((1)));
    }
}
...
SYSCTL_Deep_Sleep_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->MCTL))),"i"((2)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->MCTL))),"i"((2)));
    }
}
...
SYSCTL_Interrupt_Awake_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->MCTL))),"i"((4)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->MCTL))),"i"((4)));
    }
}
...
SYSCTL_Stack_Align_State (void)
{
    ...
    if ((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->MCTL) & ((uint32_t)1<<((9))))
    {
...
SYSCTL_Super_User_Config (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->MCTL))),"i"((15)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->MCTL))),"i"((15)));
    }
}
...
SYSCTL_Stack_Pointer_State (void)
{
    ...
    if ((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->MCTL) & ((uint32_t)1<<((16))))
    {
...
SYSCTL_Stack_Pointer_Config (uint32_t PresentSP)
{
    ...
    (((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->MCTL) = SFR_Config ((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->MCTL), ~((uint32_t)1<<((16))), PresentSP);
}
...
SYSCTL_Exception_Reset_Enable (FunctionalState NewState)
{
    ...
    tmpreg = ((uint32_t)0x05FA << (16)) |
            ((uint32_t)NewState << (1));
    (((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->ARCTL) = SFR_Config ((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->ARCTL),
                        ~(((uint32_t)1<<((1))) | ((uint32_t)0xFFFF<<((16)))),
                        tmpreg);
}
...
SYSCTL_System_Reset_Enable (FunctionalState NewState)
{
    ...
    tmpreg = ((uint32_t)0x05FA << (16)) |
            ((uint32_t)NewState << (2));
    (((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->ARCTL) = SFR_Config ((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->ARCTL),
                        ~(((uint32_t)1<<((2))) | ((uint32_t)0xFFFF<<((16)))),
                        tmpreg);
}
...
SYSCTL_Vector_Offset_Config (uint32_t VectorOffset)
{
 ...
 tmpreg = VectorOffset << (0);
    (((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->VECTOFF) = SFR_Config ((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->VECTOFF),
...
SYSCTL_Ram_Space_Config (uint32_t RamSpace)
{
 uint32_t tmpreg = 0;
    ...
    tmpreg = RamSpace << (0);
    (((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->RAMSPA) = SFR_Config ((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->RAMSPA),
                      ~((uint32_t)0x3FFFFFF<<((0))),
                      tmpreg);
}
# 450 "../src/kf32f_basic_sysctl.c"
void
SYSCTL_Flash_Start_Remap_Config (uint32_t MemCtl)
{
    ...
    (((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->MEMCTL) = SFR_Config ((((SYSCTL_SFRmap *) ((uint32_t)0x402000B0))->MEMCTL), ~((uint32_t)3<<((0))), MemCtl);
}
