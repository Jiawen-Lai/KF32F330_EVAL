	...
	.stabs	"../src/kf32f_basic_crc.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.stabn	162,0,0,0
	.stabs	"CRC_InitTypeDef:t(1,1)=(1,2)=s44m_CalUnitReset:(3,6),0,32;m_InputSize:(3,6),32,32;m_InputReverse:(3,6),64,32;m_ResultReverse:(3,6),96,32;m_Data:(3,6),128,32;m_Result:(3,6),160,32;m_InitialData:(3,6),192,32;m_Polynomial:(3,6),224,32;m_ResultXOR:(3,6),256,32;m_IndepentData:(3,6),288,32;m_Temp:(3,6),320,32;;",128,0,42,0
	.stabn	162,0,0,0
...
.Lscope1:
	...
	.align	1
	.stabs	"CRC_Reset:F(0,15)",36,0,36,CRC_Reset
	.export	CRC_Reset
	.type	CRC_Reset, @function
CRC_Reset:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_crc.c",132,0,0,.Ltext2
.Ltext2:
	.stabn	68,0,37,.LM3-.LFBB2
.LM3:
.LFBB2:
	PUSH	lr
	.stabn	68,0,38,.LM4-.LFBB2
.LM4:
	MOV	r0,#1
	LSL	r0,#13
	MOV	r1,#1
...
.Lscope2:
	...
	.align	1
	.stabs	"CRC_Configuration:F(0,15)",36,0,49,CRC_Configuration
	.stabs	"CRCInitStruct:p(0,16)=*(1,1)",160,0,49,4
	.export	CRC_Configuration
	.type	CRC_Configuration, @function
CRC_Configuration:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_crc.c",132,0,0,.Ltext3
.Ltext3:
...
.LM9:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,64,.LM10-.LFBB3
.LM10:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5]
	.stabn	68,0,65,.LM11-.LFBB3
.LM11:
	LD.w	r4,[sp+#1]
	LD.w	r4,[r4+#1]
	.stabn	68,0,64,.LM12-.LFBB3
.LM12:
	ORL	r4,r5,r4
	.stabn	68,0,66,.LM13-.LFBB3
.LM13:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#2]
	.stabn	68,0,65,.LM14-.LFBB3
.LM14:
	ORL	r4,r4,r5
	.stabn	68,0,67,.LM15-.LFBB3
.LM15:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#3]
...
.Lscope3:
	...
	.align	1
	.stabs	"CRC_Struct_Init:F(0,15)",36,0,79,CRC_Struct_Init
	.stabs	"CRCInitStruct:p(0,16)",160,0,79,0
	.export	CRC_Struct_Init
	.type	CRC_Struct_Init, @function
CRC_Struct_Init:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_crc.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,80,.LM19-.LFBB4
.LM19:
.LFBB4:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,82,.LM20-.LFBB4
.LM20:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5],r4
	.stabn	68,0,84,.LM21-.LFBB4
.LM21:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#1],r4
	.stabn	68,0,86,.LM22-.LFBB4
.LM22:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#2],r4
	.stabn	68,0,88,.LM23-.LFBB4
.LM23:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#3],r4
...
.Lscope4:
	...
	.align	1
	.stabs	"CRC_INPUT_DATA:F(0,15)",36,0,97,CRC_INPUT_DATA
	.stabs	"DATA:p(3,6)",160,0,97,0
	.export	CRC_INPUT_DATA
	.type	CRC_INPUT_DATA, @function
CRC_INPUT_DATA:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_crc.c",132,0,0,.Ltext5
.Ltext5:
	.stabn	68,0,98,.LM25-.LFBB5
.LM25:
.LFBB5:
	SUB	sp,#4
	ST.w	[sp],r0
...
.Lscope5:
	...
	.align	1
	.stabs	"CRC_GET_RESULT:F(3,6)",36,0,108,CRC_GET_RESULT
	.export	CRC_GET_RESULT
	.type	CRC_GET_RESULT, @function
CRC_GET_RESULT:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_crc.c",132,0,0,.Ltext6
.Ltext6:
	.stabn	68,0,109,.LM28-.LFBB6
.LM28:
.LFBB6:
	SUB	sp,#4
...
.LM29:
	...
	LD.w	r5,[r5+#2]
	ST.w	[sp],r5
	.stabn	68,0,113,.LM30-.LFBB6
.LM30:
	LD.w	r5,[sp]
	.stabn	68,0,114,.LM31-.LFBB6
.LM31:
	MOV	r0,r5
	ADD	sp,#4
	JMP	lr
	.size	CRC_GET_RESULT, .-CRC_GET_RESULT
	.stabs	"DATA:(3,6)",128,0,111,0
...
.Lscope6:
	...
	.align	1
	.stabs	"CRC_SET_INITVALUE:F(0,15)",36,0,121,CRC_SET_INITVALUE
	.stabs	"DATA:p(3,6)",160,0,121,0
	.export	CRC_SET_INITVALUE
	.type	CRC_SET_INITVALUE, @function
CRC_SET_INITVALUE:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_crc.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,122,.LM32-.LFBB7
.LM32:
.LFBB7:
	SUB	sp,#4
	ST.w	[sp],r0
...
.Lscope7:
	...
	.align	1
	.stabs	"CRC_SET_PLN:F(0,15)",36,0,132,CRC_SET_PLN
	.stabs	"DATA:p(3,6)",160,0,132,0
	.export	CRC_SET_PLN
	.type	CRC_SET_PLN, @function
CRC_SET_PLN:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_crc.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,133,.LM35-.LFBB8
.LM35:
.LFBB8:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,135,.LM36-.LFBB8
.LM36:
	LD	r5,#1073751680
	LD.w	r4,[sp]
	ST.w	[r5+#4],r4
	.stabn	68,0,136,.LM37-.LFBB8
.LM37:
	ADD	sp,#4
	JMP	lr
...
.Lscope8:
	...
	.align	1
	.stabs	"CRC_SET_RXOR:F(0,15)",36,0,143,CRC_SET_RXOR
	.stabs	"DATA:p(3,6)",160,0,143,0
	.export	CRC_SET_RXOR
	.type	CRC_SET_RXOR, @function
CRC_SET_RXOR:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_crc.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,144,.LM38-.LFBB9
.LM38:
.LFBB9:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,146,.LM39-.LFBB9
.LM39:
	LD	r5,#1073751680
	LD.w	r4,[sp]
	ST.w	[r5+#5],r4
	.stabn	68,0,147,.LM40-.LFBB9
.LM40:
	ADD	sp,#4
	JMP	lr
...
.Lscope9:
	...
	.align	1
	.stabs	"CRC_SET_IDATA:F(0,15)",36,0,154,CRC_SET_IDATA
	.stabs	"DATA:p(3,6)",160,0,154,0
	.export	CRC_SET_IDATA
	.type	CRC_SET_IDATA, @function
CRC_SET_IDATA:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_crc.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,155,.LM41-.LFBB10
.LM41:
.LFBB10:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,157,.LM42-.LFBB10
.LM42:
	LD	r5,#1073751680
	LD.w	r4,[sp]
	ST.w	[r5+#6],r4
	.stabn	68,0,158,.LM43-.LFBB10
.LM43:
	ADD	sp,#4
	JMP	lr
...
.Lscope10:
	...
	.align	1
	.stabs	"CRC_GET_TEMP:F(3,6)",36,0,165,CRC_GET_TEMP
	.export	CRC_GET_TEMP
	.type	CRC_GET_TEMP, @function
CRC_GET_TEMP:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_crc.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,166,.LM44-.LFBB11
.LM44:
.LFBB11:
	SUB	sp,#4
	.stabn	68,0,169,.LM45-.LFBB11
.LM45:
	LD	r5,#1073751680
	LD.w	r5,[r5+#7]
	ST.w	[sp],r5
	.stabn	68,0,170,.LM46-.LFBB11
.LM46:
	LD.w	r5,[sp]
	.stabn	68,0,171,.LM47-.LFBB11
.LM47:
	MOV	r0,r5
	ADD	sp,#4
	JMP	lr
	.size	CRC_GET_TEMP, .-CRC_GET_TEMP
	.stabs	"DATA:(3,6)",128,0,168,0
...
.Lscope11:
	...
	.align	1
	.stabs	"CRC_SET_RSET:F(0,15)",36,0,178,CRC_SET_RSET
	.export	CRC_SET_RSET
	.type	CRC_SET_RSET, @function
CRC_SET_RSET:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_crc.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,179,.LM48-.LFBB12
.LM48:
.LFBB12:
	.stabn	68,0,181,.LM49-.LFBB12
.LM49:
	LD	r4,#1073751680
	LD	r5,#1073751680
	LD.w	r5,[r5]
