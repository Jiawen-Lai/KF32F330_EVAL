...
# 16 "D:\\workspace32\\KF32Fxxx_StdPeriph_Lib_V2.3\\inc/kf32f_basic_pclk.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 14 "../src/kf32f_basic_pclk.c" 2
# 33 "../src/kf32f_basic_pclk.c"
void
                    ...
                    FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        (((PCLK_SFRmap *) ((uint32_t)0x40002640))->CTL0) |= PCLK_CTL0_bit;
    }
    else
    {
        (((PCLK_SFRmap *) ((uint32_t)0x40002640))->CTL0) &= ~PCLK_CTL0_bit;
                    ...
                    FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        (((PCLK_SFRmap *) ((uint32_t)0x40002640))->CTL1) |= PCLK_CTL1_bit;
    }
    else
    {
        (((PCLK_SFRmap *) ((uint32_t)0x40002640))->CTL1) &= ~PCLK_CTL1_bit;
                    ...
                    FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        (((PCLK_SFRmap *) ((uint32_t)0x40002640))->CTL2) |= PCLK_CTL2_bit;
    }
    else
    {
        (((PCLK_SFRmap *) ((uint32_t)0x40002640))->CTL2) &= ~PCLK_CTL2_bit;
                    ...
                    FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        (((PCLK_SFRmap *) ((uint32_t)0x40002640))->CTL3) |= PCLK_CTL3_bit;
    }
    else
    {
        (((PCLK_SFRmap *) ((uint32_t)0x40002640))->CTL3) &= ~PCLK_CTL3_bit;
