	...
	.stabs	"../src/kf32f_basic_bkp.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.stabs	"D:\\workspace32\\KF32Fxxx_StdPeriph_Lib_V2.3\\inc/kf32f_basic_bkp.h",130,0,0,0
...
.Lscope1:
	...
	.align	1
	.stabs	"BKP_Reset:F(0,15)",36,0,27,BKP_Reset
	.export	BKP_Reset
	.type	BKP_Reset, @function
BKP_Reset:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_bkp.c",132,0,0,.Ltext2
.Ltext2:
...
.Lscope2:
	...
	.align	1
	.stabs	"BKP_Write_And_Read_Enable:F(0,15)",36,0,46,BKP_Write_And_Read_Enable
	.stabs	"NewState:p(2,2)",160,0,46,4
	.export	BKP_Write_And_Read_Enable
	.type	BKP_Write_And_Read_Enable, @function
BKP_Write_And_Read_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_bkp.c",132,0,0,.Ltext3
.Ltext3:
	.stabn	68,0,47,.LM7-.LFBB3
.LM7:
.LFBB3:
	SUB	sp,#8
	ST.w	[sp+#1],r0
	.stabn	68,0,48,.LM8-.LFBB3
.LM8:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,56,.LM9-.LFBB3
.LM9:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L5
	.stabn	68,0,60,.LM10-.LFBB3
.LM10:
	MOV	r5,#1
	LSL	r5,#30
	LD.w	r5,[r5]
	ST.w	[sp],r5
	.stabn	68,0,61,.LM11-.LFBB3
.LM11:
	LD.w	r4,[sp]
	MOV	r5,#1
	ANL	r5,r4,r5
...
.LM12:
	LD	r4,#pmwrenbkp.1933
	MOV	r5,#1
	ST.w	[r4],r5
	JMP	.L7
.L6:
	.stabn	68,0,67,.LM13-.LFBB3
.LM13:
	LD	r4,#pmwrenbkp.1933
	MOV	r5,#0
	ST.w	[r4],r5
...
// inline asm end
.L7:
	.stabn	68,0,73,.LM15-.LFBB3
.LM15:
	LD	r5,#1073747328
	LD.w	r5,[r5]
	ST.w	[sp],r5
	.stabn	68,0,74,.LM16-.LFBB3
.LM16:
	LD.w	r4,[sp]
	MOV	r5,#1
	LSL	r5,#22
	...
	CMP	r5,#0
	JZ	.L8
	.stabn	68,0,76,.LM17-.LFBB3
.LM17:
	LD	r4,#bkpregclrbkp.1934
	MOV	r5,#1
	ST.w	[r4],r5
	JMP	.L9
.L8:
	.stabn	68,0,80,.LM18-.LFBB3
.LM18:
	LD	r4,#bkpregclrbkp.1934
	MOV	r5,#0
	ST.w	[r4],r5
	.stabn	68,0,82,.LM19-.LFBB3
.LM19:
	LD	r5,#1073747328
// inline asm begin
...
// inline asm end
.L9:
	.stabn	68,0,86,.LM20-.LFBB3
.LM20:
	LD	r5,#1073747328
	LD.w	r5,[r5]
	ST.w	[sp],r5
	.stabn	68,0,87,.LM21-.LFBB3
.LM21:
	LD.w	r4,[sp]
	MOV	r5,#128
	ANL	r5,r4,r5
...
// inline asm end
	JMP	.L4
.L5:
	.stabn	68,0,102,.LM25-.LFBB3
.LM25:
	LD	r5,#pmwrenbkp.1933
	LD.w	r5,[r5]
	CMP	r5,#0
	JZ	.L12
	.stabn	68,0,104,.LM26-.LFBB3
.LM26:
	LD	r4,#pmwrenbkp.1933
	MOV	r5,#1
	ST.w	[r4],r5
...
.LM29:
	LD	r5,#bkpregclrbkp.1934
	LD.w	r5,[r5]
	CMP	r5,#0
	JZ	.L14
	.stabn	68,0,116,.LM30-.LFBB3
.LM30:
	LD	r4,#bkpregclrbkp.1934
	MOV	r5,#1
	ST.w	[r4],r5
	JMP	.L15
.L14:
	.stabn	68,0,120,.LM31-.LFBB3
.LM31:
	LD	r4,#bkpregclrbkp.1934
	MOV	r5,#0
	ST.w	[r4],r5
	.stabn	68,0,122,.LM32-.LFBB3
.LM32:
	LD	r5,#1073747328
// inline asm begin
...
// inline asm end
.L15:
	.stabn	68,0,126,.LM33-.LFBB3
.LM33:
	LD	r5,#bkpwrbkp.1935
	LD.w	r5,[r5]
	CMP	r5,#0
	JZ	.L16
	.stabn	68,0,128,.LM34-.LFBB3
.LM34:
	LD	r4,#bkpwrbkp.1935
	MOV	r5,#1
	ST.w	[r4],r5
	JMP	.L4
.L16:
	.stabn	68,0,132,.LM35-.LFBB3
.LM35:
	LD	r4,#bkpwrbkp.1935
	MOV	r5,#0
	ST.w	[r4],r5
	.stabn	68,0,134,.LM36-.LFBB3
.LM36:
	LD	r5,#1073747328
// inline asm begin
...
// inline asm end
.L4:
	.stabn	68,0,137,.LM37-.LFBB3
.LM37:
	ADD	sp,#8
	JMP	lr
	.size	BKP_Write_And_Read_Enable, .-BKP_Write_And_Read_Enable
	.stabs	"tmpreg:(3,6)",128,0,48,0
	.stabs	"pmwrenbkp:V(3,6)",38,0,49,pmwrenbkp.1933
	.stabs	"bkpregclrbkp:V(3,6)",38,0,50,bkpregclrbkp.1934
	.stabs	"bkpwrbkp:V(3,6)",38,0,51,bkpwrbkp.1935
...
.Lscope3:
	...
	.align	1
	.stabs	"BKP_Reset_Enable:F(0,15)",36,0,152,BKP_Reset_Enable
	.stabs	"NewState:p(2,2)",160,0,152,0
	.export	BKP_Reset_Enable
	.type	BKP_Reset_Enable, @function
BKP_Reset_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_bkp.c",132,0,0,.Ltext4
.Ltext4:
...
.LFBB4:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,158,.LM39-.LFBB4
.LM39:
	LD.w	r5,[sp]
	CMP	r5,#0
	JZ	.L18
	.stabn	68,0,161,.LM40-.LFBB4
.LM40:
	LD	r5,#1073746944
// inline asm begin
...
.Lscope4:
	...
	.align	1
	.stabs	"BKP_Pin_Effective_Level_Config:F(0,15)",36,0,182,BKP_Pin_Effective_Level_Config
	.stabs	"PinSel:p(3,6)",160,0,182,4
	.stabs	"Effective:p(3,6)",160,0,182,8
	.export	BKP_Pin_Effective_Level_Config
	.type	BKP_Pin_Effective_Level_Config, @function
BKP_Pin_Effective_Level_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_bkp.c",132,0,0,.Ltext5
.Ltext5:
	.stabn	68,0,183,.LM43-.LFBB5
.LM43:
.LFBB5:
	SUB	sp,#12
	ST.w	[sp+#1],r0
	ST.w	[sp+#2],r1
	.stabn	68,0,184,.LM44-.LFBB5
.LM44:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,191,.LM45-.LFBB5
.LM45:
	LD.w	r4,[sp+#1]
	MOV	r5,#1
	LSL	r5,#20
	LSL	r5,r5,r4
	ST.w	[sp],r5
	.stabn	68,0,192,.LM46-.LFBB5
.LM46:
	LD.w	r5,[sp+#2]
	CMP	r5,#0
	JZ	.L21
	.stabn	68,0,195,.LM47-.LFBB5
.LM47:
	LD	r5,#1073746944
	LD	r4,#1073746944
	LD.w	r3,[r4]
...
.Lscope5:
	...
	.align	1
	.stabs	"BKP_Pin_Enable:F(0,15)",36,0,214,BKP_Pin_Enable
	.stabs	"PinSel:p(3,6)",160,0,214,4
	.stabs	"NewState:p(2,2)",160,0,214,8
	.export	BKP_Pin_Enable
	.type	BKP_Pin_Enable, @function
BKP_Pin_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_bkp.c",132,0,0,.Ltext6
.Ltext6:
	.stabn	68,0,215,.LM50-.LFBB6
.LM50:
.LFBB6:
	SUB	sp,#12
	ST.w	[sp+#1],r0
...
.LM55:
	...
	ST.w	[r4],r5
.L23:
	.stabn	68,0,234,.LM56-.LFBB6
.LM56:
	ADD	sp,#12
	JMP	lr
	.size	BKP_Pin_Enable, .-BKP_Pin_Enable
	.stabs	"tmpreg:(3,6)",128,0,216,0
...
.Lscope6:
	...
	.align	1
	.stabs	"BKP_RTC_Clock_Config:F(0,15)",36,0,246,BKP_RTC_Clock_Config
	.stabs	"Source:p(3,6)",160,0,246,0
	.export	BKP_RTC_Clock_Config
	.type	BKP_RTC_Clock_Config, @function
BKP_RTC_Clock_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_bkp.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,247,.LM57-.LFBB7
.LM57:
.LFBB7:
	PUSH	{r6, lr}
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,252,.LM58-.LFBB7
.LM58:
	LD	r6,#1073746944
	LD	r5,#1073746944
	LD.w	r5,[r5]
...
.Lscope7:
	...
	.align	1
	.stabs	"BKP_External_Clock_Bypass_Enable:F(0,15)",36,0,264,BKP_External_Clock_Bypass_Enable
	.stabs	"Source:p(3,6)",160,0,264,4
	.stabs	"NewState:p(2,2)",160,0,264,8
	.export	BKP_External_Clock_Bypass_Enable
	.type	BKP_External_Clock_Bypass_Enable, @function
BKP_External_Clock_Bypass_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_bkp.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,265,.LM60-.LFBB8
.LM60:
.LFBB8:
	SUB	sp,#12
	ST.w	[sp+#1],r0
	ST.w	[sp+#2],r1
	.stabn	68,0,266,.LM61-.LFBB8
.LM61:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,273,.LM62-.LFBB8
.LM62:
	LD.w	r4,[sp+#1]
	MOV	r5,#2
	LSL	r5,r5,r4
	ST.w	[sp],r5
	.stabn	68,0,274,.LM63-.LFBB8
.LM63:
	LD.w	r5,[sp+#2]
	CMP	r5,#0
	JZ	.L28
	.stabn	68,0,277,.LM64-.LFBB8
.LM64:
	LD	r5,#1073746944
	LD	r4,#1073746944
	LD.w	r3,[r4]
...
.Lscope8:
	...
	.align	1
	.stabs	"BKP_Data_Config:F(0,15)",36,0,293,BKP_Data_Config
	.stabs	"OrderNumber:p(3,6)",160,0,293,0
	.stabs	"WriteData:p(3,6)",160,0,293,4
	.export	BKP_Data_Config
	.type	BKP_Data_Config, @function
BKP_Data_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_bkp.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,294,.LM67-.LFBB9
.LM67:
.LFBB9:
	SUB	sp,#8
	ST.w	[sp],r0
	ST.w	[sp+#1],r1
	.stabn	68,0,299,.LM68-.LFBB9
.LM68:
	LD	r4,#1073746944
	LD.w	r5,[sp]
	ADD	r5,#16
...
.Lscope9:
	...
	.align	1
	.stabs	"BKP_Get_Data:F(3,6)",36,0,308,BKP_Get_Data
	.stabs	"OrderNumber:p(3,6)",160,0,308,4
	.export	BKP_Get_Data
	.type	BKP_Get_Data, @function
BKP_Get_Data:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_bkp.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,309,.LM70-.LFBB10
.LM70:
.LFBB10:
	SUB	sp,#8
	ST.w	[sp+#1],r0
	.stabn	68,0,310,.LM71-.LFBB10
.LM71:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,316,.LM72-.LFBB10
.LM72:
	LD	r4,#1073746944
	LD.w	r5,[sp+#1]
	ADD	r5,#16
	...
	LD.w	r5,[r5]
	ST.w	[sp],r5
	.stabn	68,0,318,.LM73-.LFBB10
.LM73:
	LD.w	r5,[sp]
	.stabn	68,0,319,.LM74-.LFBB10
.LM74:
	MOV	r0,r5
	ADD	sp,#8
	JMP	lr
	.size	BKP_Get_Data, .-BKP_Get_Data
	.stabs	"tmpreg:(3,6)",128,0,310,0
...
.Lscope10:
	...
	.align	1
	.stabs	"BKP_Pin_TAMP_INT_Enable:F(0,15)",36,0,338,BKP_Pin_TAMP_INT_Enable
	.stabs	"PinSel:p(3,6)",160,0,338,4
	.stabs	"NewState:p(2,2)",160,0,338,8
	.export	BKP_Pin_TAMP_INT_Enable
	.type	BKP_Pin_TAMP_INT_Enable, @function
BKP_Pin_TAMP_INT_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_bkp.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,339,.LM75-.LFBB11
.LM75:
.LFBB11:
	SUB	sp,#12
	ST.w	[sp+#1],r0
	ST.w	[sp+#2],r1
	.stabn	68,0,340,.LM76-.LFBB11
.LM76:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,347,.LM77-.LFBB11
.LM77:
	LD.w	r4,[sp+#1]
	MOV	r5,#255
	ADD	r5,r5,#1
	LSL	r5,r5,r4
	ST.w	[sp],r5
	.stabn	68,0,348,.LM78-.LFBB11
.LM78:
	LD.w	r5,[sp+#2]
	CMP	r5,#0
	JZ	.L34
	.stabn	68,0,351,.LM79-.LFBB11
.LM79:
	LD	r5,#1073746944
	LD	r4,#1073746944
	LD.w	r3,[r4+#1]
...
.LM80:
	...
	ST.w	[r4+#1],r5
.L33:
	.stabn	68,0,358,.LM81-.LFBB11
.LM81:
	ADD	sp,#12
	JMP	lr
	.size	BKP_Pin_TAMP_INT_Enable, .-BKP_Pin_TAMP_INT_Enable
	.stabs	"tmpreg:(3,6)",128,0,340,0
...
.Lscope11:
	...
	.align	1
	.stabs	"BKP_Get_Pin_TAMP_INT_Flag:F(2,4)",36,0,369,BKP_Get_Pin_TAMP_INT_Flag
	.stabs	"PinSel:p(3,6)",160,0,369,4
	.export	BKP_Get_Pin_TAMP_INT_Flag
	.type	BKP_Get_Pin_TAMP_INT_Flag, @function
BKP_Get_Pin_TAMP_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_bkp.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,370,.LM82-.LFBB12
.LM82:
.LFBB12:
	SUB	sp,#8
	ST.w	[sp+#1],r0
	.stabn	68,0,371,.LM83-.LFBB12
.LM83:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,377,.LM84-.LFBB12
.LM84:
	LD.w	r4,[sp+#1]
	MOV	r5,#1
	LSL	r5,#16
...
.LM85:
	...
	CMP	r5,#0
	JZ	.L37
	.stabn	68,0,381,.LM86-.LFBB12
.LM86:
	MOV	r5,#1
	JMP	.L38
.L37:
	.stabn	68,0,386,.LM87-.LFBB12
.LM87:
	MOV	r5,#0
.L38:
	.stabn	68,0,388,.LM88-.LFBB12
.LM88:
	MOV	r0,r5
	ADD	sp,#8
	JMP	lr
...
.Lscope12:
	...
	.align	1
	.stabs	"BKP_Clear_Pin_TAMP_INT_Flag:F(0,15)",36,0,399,BKP_Clear_Pin_TAMP_INT_Flag
	.stabs	"PinSel:p(3,6)",160,0,399,8
	.export	BKP_Clear_Pin_TAMP_INT_Flag
	.type	BKP_Clear_Pin_TAMP_INT_Flag, @function
BKP_Clear_Pin_TAMP_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_bkp.c",132,0,0,.Ltext13
.Ltext13:
	.stabn	68,0,400,.LM89-.LFBB13
.LM89:
.LFBB13:
	SUB	sp,#12
	ST.w	[sp+#2],r0
	.stabn	68,0,401,.LM90-.LFBB13
.LM90:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,402,.LM91-.LFBB13
.LM91:
	MOV	r5,#0
	ST.w	[sp+#1],r5
	.stabn	68,0,407,.LM92-.LFBB13
.LM92:
	LD.w	r4,[sp+#2]
	MOV	r5,#1
	LSL	r5,r5,r4
	ST.w	[sp],r5
	.stabn	68,0,408,.LM93-.LFBB13
.LM93:
	LD.w	r4,[sp+#2]
	MOV	r5,#1
	LSL	r5,#16
...
.LM96:
	...
	ANL	r5,r3,r5
	ST.w	[r4+#1],r5
	.stabn	68,0,412,.LM97-.LFBB13
.LM97:
	ADD	sp,#12
	JMP	lr
	.size	BKP_Clear_Pin_TAMP_INT_Flag, .-BKP_Clear_Pin_TAMP_INT_Flag
	.stabs	"tmpreg:(3,6)",128,0,401,0
	.stabs	"tmpreg1:(3,6)",128,0,402,4
	.stabn	192,0,0,.LFBB13-.LFBB13
	.stabn	224,0,0,.Lscope13-.LFBB13
.Lscope13:
	.stabs	"",36,0,0,.Lscope13-.LFBB13
	.stabd	78,0,0
	.section .data$pmwrenbkp.1933
	.align	2
	.type	pmwrenbkp.1933, @object
	.size	pmwrenbkp.1933, 4
pmwrenbkp.1933:
	.long	1
	.section .data$bkpregclrbkp.1934
	.align	2
	.type	bkpregclrbkp.1934, @object
	.size	bkpregclrbkp.1934, 4
bkpregclrbkp.1934:
	.long	1
	.section .data$bkpwrbkp.1935
	.align	2
	.type	bkpwrbkp.1935, @object
	.size	bkpwrbkp.1935, 4
bkpwrbkp.1935:
	.long	1
	.text
