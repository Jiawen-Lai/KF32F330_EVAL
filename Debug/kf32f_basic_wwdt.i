...
# 15 "D:\\workspace32\\KF32Fxxx_StdPeriph_Lib_V2.3\\inc/kf32f_basic_wwdt.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 17 "../src/kf32f_basic_wwdt.c" 2
# 27 "../src/kf32f_basic_wwdt.c"
void
WWDT_Reset (void)
{

    RST_CTL2_Peripheral_Reset_Enable(((uint32_t)1<<((5))), TRUE);
    RST_CTL2_Peripheral_Reset_Enable(((uint32_t)1<<((5))), FALSE);


    PCLK_CTL2_Peripheral_Clock_Enable(((uint32_t)1<<((5))), TRUE);
}
...
WWDT_Threshold_Config (uint32_t Threshold)
{
    ...
    tmpreg = Threshold << (8);
    (((WWDT_SFRmap *) ((uint32_t)0x40001280))->CTL) = SFR_Config ((((WWDT_SFRmap *) ((uint32_t)0x40001280))->CTL), ~((uint32_t)0x7F<<((8))), tmpreg);
}
# 80 "../src/kf32f_basic_wwdt.c"
void
WWDT_Prescaler_Config (uint32_t Prescaler)
{
    ...
    (((WWDT_SFRmap *) ((uint32_t)0x40001280))->CTL) = SFR_Config ((((WWDT_SFRmap *) ((uint32_t)0x40001280))->CTL), ~((uint32_t)0x1F<<((3))), Prescaler);
}
...
WWDT_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((WWDT_SFRmap *) ((uint32_t)0x40001280))->CTL))),"i"((0)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((WWDT_SFRmap *) ((uint32_t)0x40001280))->CTL))),"i"((0)));
    }
}
...
WWDT_Counter_Config (uint32_t Counter)
{
    ...
    (((WWDT_SFRmap *) ((uint32_t)0x40001280))->CNT) = Counter;
}
...
WWDT_Get_Counter (void)
{
    ...
    tmpreg = (((WWDT_SFRmap *) ((uint32_t)0x40001280))->CNT) & ((uint32_t)0x7F<<((0)));
    tmpreg >>= (0);

    return tmpreg;
}
# 158 "../src/kf32f_basic_wwdt.c"
void
WWDT_INT_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((WWDT_SFRmap *) ((uint32_t)0x40001280))->CTL))),"i"((1)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((WWDT_SFRmap *) ((uint32_t)0x40001280))->CTL))),"i"((1)));
    }
}
...
WWDT_Get_INT_Flag (void)
{
    ...
    if ((((WWDT_SFRmap *) ((uint32_t)0x40001280))->CTL) & ((uint32_t)1<<((2))))
    {
...
WWDT_Clear_INT_Flag (void)
{
    ...
    __asm volatile("SET [%0], #%1"::"r"(&((((WWDT_SFRmap *) ((uint32_t)0x40001280))->CTL))),"i"((15)));
    while((((WWDT_SFRmap *) ((uint32_t)0x40001280))->CTL) & ((uint32_t)1<<((2))));
    __asm volatile("CLR [%0], #%1"::"r"(&((((WWDT_SFRmap *) ((uint32_t)0x40001280))->CTL))),"i"((15)));
}
