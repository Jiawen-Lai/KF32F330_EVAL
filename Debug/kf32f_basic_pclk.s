	...
	.stabs	"../src/kf32f_basic_pclk.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.stabs	"D:\\workspace32\\KF32Fxxx_StdPeriph_Lib_V2.3\\inc/kf32f_basic_pclk.h",130,0,0,0
	...
	.align	1
	.stabs	"PCLK_CTL0_Peripheral_Clock_Enable:F(0,15)",36,0,34,PCLK_CTL0_Peripheral_Clock_Enable
	.stabs	"PCLK_CTL0_bit:p(3,6)",160,0,34,0
	.stabs	"NewState:p(2,2)",160,0,35,4
	.export	PCLK_CTL0_Peripheral_Clock_Enable
	.type	PCLK_CTL0_Peripheral_Clock_Enable, @function
PCLK_CTL0_Peripheral_Clock_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_pclk.c",132,0,0,.Ltext1
.Ltext1:
	.stabn	68,0,36,.LM0-.LFBB1
.LM0:
.LFBB1:
	SUB	sp,#8
	ST.w	[sp],r0
...
.Lscope1:
	...
	.align	1
	.stabs	"PCLK_CTL1_Peripheral_Clock_Enable:F(0,15)",36,0,86,PCLK_CTL1_Peripheral_Clock_Enable
	.stabs	"PCLK_CTL1_bit:p(3,6)",160,0,86,0
	.stabs	"NewState:p(2,2)",160,0,87,4
	.export	PCLK_CTL1_Peripheral_Clock_Enable
	.type	PCLK_CTL1_Peripheral_Clock_Enable, @function
PCLK_CTL1_Peripheral_Clock_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_pclk.c",132,0,0,.Ltext2
.Ltext2:
	.stabn	68,0,88,.LM5-.LFBB2
.LM5:
.LFBB2:
	SUB	sp,#8
	ST.w	[sp],r0
	ST.w	[sp+#1],r1
	.stabn	68,0,93,.LM6-.LFBB2
.LM6:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L5
	.stabn	68,0,95,.LM7-.LFBB2
.LM7:
	LD	r5,#1073751616
	LD	r4,#1073751616
	LD.w	r3,[r4+#1]
...
.Lscope2:
	...
	.align	1
	.stabs	"PCLK_CTL2_Peripheral_Clock_Enable:F(0,15)",36,0,128,PCLK_CTL2_Peripheral_Clock_Enable
	.stabs	"PCLK_CTL2_bit:p(3,6)",160,0,128,0
	.stabs	"NewState:p(2,2)",160,0,129,4
	.export	PCLK_CTL2_Peripheral_Clock_Enable
	.type	PCLK_CTL2_Peripheral_Clock_Enable, @function
PCLK_CTL2_Peripheral_Clock_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_pclk.c",132,0,0,.Ltext3
.Ltext3:
	.stabn	68,0,130,.LM10-.LFBB3
.LM10:
.LFBB3:
	SUB	sp,#8
	ST.w	[sp],r0
	ST.w	[sp+#1],r1
	.stabn	68,0,135,.LM11-.LFBB3
.LM11:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L8
	.stabn	68,0,137,.LM12-.LFBB3
.LM12:
	LD	r5,#1073751616
	LD	r4,#1073751616
	LD.w	r3,[r4+#2]
...
.Lscope3:
	...
	.align	1
	.stabs	"PCLK_CTL3_Peripheral_Clock_Enable:F(0,15)",36,0,163,PCLK_CTL3_Peripheral_Clock_Enable
	.stabs	"PCLK_CTL3_bit:p(3,6)",160,0,163,0
	.stabs	"NewState:p(2,2)",160,0,164,4
	.export	PCLK_CTL3_Peripheral_Clock_Enable
	.type	PCLK_CTL3_Peripheral_Clock_Enable, @function
PCLK_CTL3_Peripheral_Clock_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_pclk.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,165,.LM15-.LFBB4
.LM15:
.LFBB4:
	SUB	sp,#8
	ST.w	[sp],r0
	ST.w	[sp+#1],r1
	.stabn	68,0,170,.LM16-.LFBB4
.LM16:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L11
	.stabn	68,0,172,.LM17-.LFBB4
.LM17:
	LD	r5,#1073751616
	LD	r4,#1073751616
	LD.w	r3,[r4+#3]
