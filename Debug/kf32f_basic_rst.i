...
# 16 "D:\\workspace32\\KF32Fxxx_StdPeriph_Lib_V2.3\\inc/kf32f_basic_rst.h" 2
...
void RST_CTL3_Peripheral_Reset_Enable(uint32_t RST_CTL3Periph,
                    FunctionalState NewState);
# 14 "../src/kf32f_basic_rst.c" 2
# 34 "../src/kf32f_basic_rst.c"
void
                    ...
                    FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        (((RST_SFRmap *) ((uint32_t)0x40001500))->CTL0) |= RST_CTL0_bit;
    }
    else
    {
        (((RST_SFRmap *) ((uint32_t)0x40001500))->CTL0) &= ~RST_CTL0_bit;
                    ...
                    FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        (((RST_SFRmap *) ((uint32_t)0x40001500))->CTL1) |= RST_CTL1_bit;
    }
    else
    {
        (((RST_SFRmap *) ((uint32_t)0x40001500))->CTL1) &= ~RST_CTL1_bit;
                    ...
                    FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        (((RST_SFRmap *) ((uint32_t)0x40001500))->CTL2) |= RST_CTL2_bit;
    }
    else
    {
        (((RST_SFRmap *) ((uint32_t)0x40001500))->CTL2) &= ~RST_CTL2_bit;
                    ...
                    FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        (((RST_SFRmap *) ((uint32_t)0x40001500))->CTL3) |= RST_CTL3_bit;
    }
    else
    {
        (((RST_SFRmap *) ((uint32_t)0x40001500))->CTL3) &= ~RST_CTL3_bit;
