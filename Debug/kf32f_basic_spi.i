...
# 16 "D:\\workspace32\\KF32Fxxx_StdPeriph_Lib_V2.3\\inc/kf32f_basic_spi.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 18 "../src/kf32f_basic_spi.c" 2
# 45 "../src/kf32f_basic_spi.c"
void
SPI_Reset(SPI_SFRmap* SPIx)
{
    ...
    if (SPIx == ((SPI_SFRmap *) ((uint32_t)0x40000C00)))
    {
       RST_CTL1_Peripheral_Reset_Enable(((uint32_t)1<<((24))), TRUE);
       RST_CTL1_Peripheral_Reset_Enable(((uint32_t)1<<((24))), FALSE);
       PCLK_CTL1_Peripheral_Clock_Enable(((uint32_t)1<<((24))), TRUE);
    }


    if (SPIx == ((SPI_SFRmap *) ((uint32_t)0x40000C80)))
    {
       RST_CTL1_Peripheral_Reset_Enable(((uint32_t)1<<((25))), TRUE);
       RST_CTL1_Peripheral_Reset_Enable(((uint32_t)1<<((25))), FALSE);
       PCLK_CTL1_Peripheral_Clock_Enable(((uint32_t)1<<((25))), TRUE);
    }


    if (SPIx == ((SPI_SFRmap *) ((uint32_t)0x40002080)))
    {
       RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((1))), TRUE);
       RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((1))), FALSE);
       PCLK_CTL3_Peripheral_Clock_Enable(((uint32_t)1<<((1))), TRUE);
    }


    if (SPIx == ((SPI_SFRmap *) ((uint32_t)0x40002100)))
    {
       RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((2))), TRUE);
       RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((2))), FALSE);
       PCLK_CTL3_Peripheral_Clock_Enable(((uint32_t)1<<((2))), TRUE);
    }
...
# 111 "../src/kf32f_basic_spi.c"
    ...
    SPIx->CTLR = SFR_Config (SPIx->CTLR, ~(((uint32_t)7<<((1))) | ((uint32_t)3<<((4))) | ((uint32_t)1<<((6))) | ((uint32_t)1<<((8))) | ((uint32_t)1<<((9))) | ((uint32_t)3<<((12))) ), tmpreg);



    tmpreg = (uint32_t)spiInitStruct->m_BaudRate << (0);
    SPIx->BRGR = SFR_Config (SPIx->BRGR, ~((uint32_t)0xFFFF<<((0))), tmpreg);
}
...
I2S_Configuration(SPI_SFRmap* SPIx, I2S_InitTypeDef* i2sInitStruct)
{
    ...
    tmpreg = ((i2sInitStruct->m_Mode)
            ...
            | (i2sInitStruct->m_CKP));
    SPIx->CTLR = SFR_Config (SPIx->CTLR, ~(((uint32_t)3<<((20))) | ((uint32_t)3<<((22))) | ((uint32_t)1<<((24))) | ((uint32_t)0x3<<((25))) | ((uint32_t)1<<((27))) ) , tmpreg);



    tmpreg = (uint32_t)i2sInitStruct->m_Prescaler << (16);
    SPIx->BRGR = SFR_Config (SPIx->BRGR, ~((uint32_t)0xFF<<((16))), tmpreg);
}
...
SPI_Struct_Init(SPI_InitTypeDef* SPI_InitStruct)
{
    ...
    SPI_InitStruct->m_Mode = ((uint32_t)4<<(1));

    SPI_InitStruct->m_Clock = ((uint32_t)1<<(4));

    SPI_InitStruct->m_FirstBit = ((uint32_t)1<<(6));

    SPI_InitStruct->m_CKP = ((uint32_t)0<<(8));

    SPI_InitStruct->m_CKE = ((uint32_t)0<<(9));

    SPI_InitStruct->m_DataSize = ((uint32_t)0<<(12));
...
I2S_Struct_Init(I2S_InitTypeDef* I2S_InitStruct)
{
    ...
    I2S_InitStruct->m_Mode = ((uint32_t)0<<(20));

    I2S_InitStruct->m_Standard = ((uint32_t)0<<(22));

    I2S_InitStruct->m_PCM = ((uint32_t)1<<(24));

    I2S_InitStruct->m_Clock = ((uint32_t)0<<(25));

    I2S_InitStruct->m_CKP = ((uint32_t)0<<(27));

    I2S_InitStruct->m_Prescaler = 0;
}
# 222 "../src/kf32f_basic_spi.c"
void
SPI_Cmd (SPI_SFRmap* SPIx, FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((0)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((0)));
    }
}
# 251 "../src/kf32f_basic_spi.c"
void
I2S_Mode_Select(SPI_SFRmap* SPIx, FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((16)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((16)));
    }
}
...
I2S_DIV_Config (SPI_SFRmap* SPIx,uint8_t DIV)
{
    ...
    tmpreg = (uint32_t)DIV << (16);
    SPIx->BRGR = SFR_Config (SPIx->BRGR, ~((uint32_t)0xFF<<((16))), tmpreg);
}
# 368 "../src/kf32f_basic_spi.c"
void
SPI_MODE_Config (SPI_SFRmap* SPIx,uint32_t MODE)
{
    ...
    SPIx->CTLR = SFR_Config (SPIx->CTLR, ~((uint32_t)7<<((1))), MODE);
}
# 388 "../src/kf32f_basic_spi.c"
void
SPI_CLK_Config (SPI_SFRmap* SPIx,uint32_t ClockSource)
{
    ...
    SPIx->CTLR = SFR_Config (SPIx->CTLR, ~((uint32_t)3<<((4))), ClockSource);
}
# 407 "../src/kf32f_basic_spi.c"
void
SPI_Data_Direction_Config(SPI_SFRmap* SPIx,uint32_t DataDirection)
{
    ...
    if (DataDirection != ((uint32_t)0<<(6)))
    {

        __asm volatile("SET [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((6)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((6)));
    }
}
# 435 "../src/kf32f_basic_spi.c"
void
SPI_Clock_Polarity_Config (SPI_SFRmap* SPIx,uint32_t Polarity)
{
    ...
    if (Polarity != ((uint32_t)0<<(8)))
    {

        __asm volatile("SET [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((8)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((8)));
    }
}
# 463 "../src/kf32f_basic_spi.c"
void
SPI_Clock_Edge_Config (SPI_SFRmap* SPIx,uint32_t ClockEdge)
{
    ...
    if (ClockEdge != ((uint32_t)0<<(9)))
    {

        __asm volatile("SET [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((9)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((9)));
    }
}
# 492 "../src/kf32f_basic_spi.c"
void
SPI_BIT_SELECT_Config(SPI_SFRmap* SPIx,uint32_t DataSize)
{
    ...
    SPIx->CTLR = SFR_Config (SPIx->CTLR, ~((uint32_t)3<<((12))), DataSize);
}
# 513 "../src/kf32f_basic_spi.c"
void
SPI_I2S_MODE_Config (SPI_SFRmap* SPIx,uint32_t Mode)
{
    ...
    SPIx->CTLR = SFR_Config (SPIx->CTLR, ~((uint32_t)3<<((20))), Mode);
}
# 534 "../src/kf32f_basic_spi.c"
void
SPI_I2S_STANDARD_Config(SPI_SFRmap* SPIx,uint32_t Standard)
{
    ...
    SPIx->CTLR = SFR_Config (SPIx->CTLR, ~((uint32_t)3<<((22))), Standard);
}
# 553 "../src/kf32f_basic_spi.c"
void
SPI_PCM_Config (SPI_SFRmap* SPIx,uint32_t NewState)
{
    ...
    if (NewState != ((uint32_t)0<<(24)))
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((24)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((24)));
    }
}
# 581 "../src/kf32f_basic_spi.c"
void
SPI_CHLEN_Config (SPI_SFRmap* SPIx,uint32_t NewState)
{
    ...
    if (NewState == ((uint32_t)3<<(25)))
    {

        __asm volatile("SET [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((25)));
        __asm volatile("SET [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((26)));
    }
    else if(NewState == ((uint32_t)2<<(25)))
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((25)));
        __asm volatile("SET [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((26)));
    }
    else
    {
     ...
     __asm volatile("CLR [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((25)));
     __asm volatile("CLR [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((26)));
    }
}
# 617 "../src/kf32f_basic_spi.c"
void
SPI_PCM_CLOCK_Polarity_Config(SPI_SFRmap* SPIx,uint32_t NewState)
{
    ...
    if (NewState != ((uint32_t)0<<(27)))
    {

        __asm volatile("SET [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((27)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((27)));
    }
}
...
SPI_MAIN_CLOCK_OUT_Enable (SPI_SFRmap* SPIx,FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(SPIx->BRGR)),"i"((24)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(SPIx->BRGR)),"i"((24)));
    }
}
# 676 "../src/kf32f_basic_spi.c"
void
SPI_Receive_Overflow_INT_Enable (SPI_SFRmap* SPIx,FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(SPIx->STR)),"i"((12)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(SPIx->STR)),"i"((12)));
    }
}
...
SPI_Transmit_Overflow_INT_Enable (SPI_SFRmap* SPIx,FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(SPIx->STR)),"i"((13)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(SPIx->STR)),"i"((13)));
    }
}
...
SPI_RNEIE_INT_Enable (SPI_SFRmap* SPIx, FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(SPIx->STR)),"i"((14)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(SPIx->STR)),"i"((14)));
    }
}
...
SPI_TNEIE_INT_Enable (SPI_SFRmap* SPIx,FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(SPIx->STR)),"i"((15)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(SPIx->STR)),"i"((15)));
    }
}
# 781 "../src/kf32f_basic_spi.c"
void
SPI_Receive_DMA_INT_Enable (SPI_SFRmap* SPIx,FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(SPIx->STR)),"i"((20)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(SPIx->STR)),"i"((20)));
    }
}
...
SPI_Transmit_DMA_INT_Enable (SPI_SFRmap* SPIx,FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(SPIx->STR)),"i"((21)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(SPIx->STR)),"i"((21)));
    }
}
...
SPI_Transmit_CHSIDE_INT_Enable (SPI_SFRmap* SPIx, FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(SPIx->STR)),"i"((3)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(SPIx->STR)),"i"((3)));
    }
}
...
SPI_Clear_Receive_Overflow_INT_Flag (SPI_SFRmap* SPIx)
{
    ...
    __asm volatile("SET [%0], #%1"::"r"(&(SPIx->STR)),"i"((16)));
    while(SPIx->STR & ((uint32_t)1<<((4))));
    __asm volatile("CLR [%0], #%1"::"r"(&(SPIx->STR)),"i"((16)));
}
...
SPI_Clear_Transmit_Overflow_INT_Flag (SPI_SFRmap* SPIx)
{
    ...
    __asm volatile("SET [%0], #%1"::"r"(&(SPIx->STR)),"i"((17)));
    while(SPIx->STR & ((uint32_t)1<<((5))));
    __asm volatile("CLR [%0], #%1"::"r"(&(SPIx->STR)),"i"((17)));
}
