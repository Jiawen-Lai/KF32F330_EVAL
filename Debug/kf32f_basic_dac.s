	...
	.stabs	"../src/kf32f_basic_dac.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.stabn	162,0,0,0
	.stabs	"DAC_InitTypeDef:t(1,1)=(1,2)=s40m_TriggerEnable:(2,2),0,32;m_TriggerEvent:(3,6),32,32;m_TriggerDMAEnable:(2,2),64,32;m_Wave:(3,6),96,32;m_Mas:(3,6),128,32;m_Clock:(3,6),160,32;m_ReferenceVoltage:(3,6),192,32;m_OutputBuffer:(2,2),224,32;m_OutputPin:(3,6),256,32;m_Output:(3,6),288,32;;",128,0,50,0
	.stabs	"DAC_CALTypeDef:t(1,3)=(1,4)=s20m_PPositrim:(3,6),0,32;m_PNegatrim:(3,6),32,32;m_NPositrim:(3,6),64,32;m_NNegatrim:(3,6),96,32;m_Buftrim:(3,6),128,32;;",128,0,67,0
	.stabn	162,0,0,0
...
.Lscope1:
	...
	.align	1
	.stabs	"DAC_Reset:F(0,15)",36,0,51,DAC_Reset
	.stabs	"DACx:p(0,16)=*(2,61)",160,0,51,0
	.export	DAC_Reset
	.type	DAC_Reset, @function
DAC_Reset:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_dac.c",132,0,0,.Ltext2
.Ltext2:
...
.Lscope2:
	...
	.align	1
	.stabs	"DAC_Configuration:F(0,15)",36,0,81,DAC_Configuration
	.stabs	"DACx:p(0,16)",160,0,81,4
	.stabs	"dacInitStruct:p(0,17)=*(1,1)",160,0,81,8
	.export	DAC_Configuration
	.type	DAC_Configuration, @function
DAC_Configuration:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_dac.c",132,0,0,.Ltext3
.Ltext3:
	.stabn	68,0,82,.LM13-.LFBB3
.LM13:
.LFBB3:
	PUSH	lr
	SUB	sp,#12
...
.LM16:
	LD.w	r5,[sp+#2]
	LD.w	r5,[r5+#1]
	.stabn	68,0,104,.LM17-.LFBB3
.LM17:
	ORL	r4,r4,r5
	.stabn	68,0,106,.LM18-.LFBB3
.LM18:
	LD.w	r5,[sp+#2]
	LD.w	r5,[r5+#2]
	ADD	r5,r5,r5
	.stabn	68,0,105,.LM19-.LFBB3
.LM19:
	ORL	r4,r4,r5
	.stabn	68,0,107,.LM20-.LFBB3
.LM20:
	LD.w	r5,[sp+#2]
	LD.w	r5,[r5+#3]
...
.LM21:
	ORL	r4,r4,r5
	.stabn	68,0,108,.LM22-.LFBB3
.LM22:
	LD.w	r5,[sp+#2]
	LD.w	r5,[r5+#4]
	.stabn	68,0,104,.LM23-.LFBB3
.LM23:
	ORL	r5,r4,r5
	ST.w	[sp],r5
	.stabn	68,0,109,.LM24-.LFBB3
.LM24:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5]
	MOV	r0,r5
	...
	LD.w	r4,[sp+#1]
	ST.w	[r4],r5
	.stabn	68,0,116,.LM25-.LFBB3
.LM25:
	LD.w	r5,[sp+#2]
	LD.w	r4,[r5+#5]
	.stabn	68,0,117,.LM26-.LFBB3
.LM26:
	LD.w	r5,[sp+#2]
	LD.w	r5,[r5+#6]
	ORL	r4,r4,r5
	.stabn	68,0,118,.LM27-.LFBB3
.LM27:
	LD.w	r5,[sp+#2]
	LD.w	r5,[r5+#7]
	LSL	r5,#6
	ORL	r4,r4,r5
	.stabn	68,0,119,.LM28-.LFBB3
.LM28:
	LD.w	r5,[sp+#2]
	LD.w	r5,[r5+#8]
	.stabn	68,0,116,.LM29-.LFBB3
.LM29:
	ORL	r5,r4,r5
	ST.w	[sp],r5
	.stabn	68,0,120,.LM30-.LFBB3
.LM30:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#3]
	MOV	r0,r5
...
.Lscope3:
	...
	.align	1
	.stabs	"DAC_Struct_Init:F(0,15)",36,0,134,DAC_Struct_Init
	.stabs	"dacInitStruct:p(0,17)",160,0,134,0
	.export	DAC_Struct_Init
	.type	DAC_Struct_Init, @function
DAC_Struct_Init:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_dac.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,135,.LM34-.LFBB4
.LM34:
.LFBB4:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,137,.LM35-.LFBB4
.LM35:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5],r4
	.stabn	68,0,139,.LM36-.LFBB4
.LM36:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#1],r4
	.stabn	68,0,141,.LM37-.LFBB4
.LM37:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#2],r4
	.stabn	68,0,143,.LM38-.LFBB4
.LM38:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#3],r4
	.stabn	68,0,145,.LM39-.LFBB4
.LM39:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#4],r4
	.stabn	68,0,147,.LM40-.LFBB4
.LM40:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#5],r4
...
.LM41:
	...
	MOV	r4,#0
	ST.w	[r5+#6],r4
	.stabn	68,0,151,.LM42-.LFBB4
.LM42:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#7],r4
	.stabn	68,0,153,.LM43-.LFBB4
.LM43:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#8],r4
	.stabn	68,0,155,.LM44-.LFBB4
.LM44:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#9],r4
	.stabn	68,0,156,.LM45-.LFBB4
.LM45:
	ADD	sp,#4
	JMP	lr
...
.Lscope4:
	...
	.align	1
	.stabs	"DAC_Cmd:F(0,15)",36,0,166,DAC_Cmd
	.stabs	"DACx:p(0,16)",160,0,166,0
	.stabs	"NewState:p(2,2)",160,0,166,4
	.export	DAC_Cmd
	.type	DAC_Cmd, @function
DAC_Cmd:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_dac.c",132,0,0,.Ltext5
.Ltext5:
	.stabn	68,0,167,.LM46-.LFBB5
.LM46:
.LFBB5:
	SUB	sp,#8
	ST.w	[sp],r0
	ST.w	[sp+#1],r1
	.stabn	68,0,172,.LM47-.LFBB5
.LM47:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L9
	.stabn	68,0,175,.LM48-.LFBB5
.LM48:
	LD.w	r5,[sp]
// inline asm begin
...
.Lscope5:
	...
	.align	1
	.stabs	"DAC_Software_Trigger_Cmd:F(0,15)",36,0,192,DAC_Software_Trigger_Cmd
	.stabs	"DACx:p(0,16)",160,0,192,0
	.stabs	"NewState:p(2,2)",160,0,192,4
	.export	DAC_Software_Trigger_Cmd
	.type	DAC_Software_Trigger_Cmd, @function
DAC_Software_Trigger_Cmd:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_dac.c",132,0,0,.Ltext6
.Ltext6:
	.stabn	68,0,193,.LM51-.LFBB6
.LM51:
.LFBB6:
	SUB	sp,#8
	ST.w	[sp],r0
	ST.w	[sp+#1],r1
	.stabn	68,0,198,.LM52-.LFBB6
.LM52:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L12
	.stabn	68,0,201,.LM53-.LFBB6
.LM53:
	LD.w	r5,[sp]
// inline asm begin
...
.Lscope6:
	...
	.align	1
	.stabs	"DAC_DMA_Cmd:F(0,15)",36,0,218,DAC_DMA_Cmd
	.stabs	"DACx:p(0,16)",160,0,218,0
	.stabs	"NewState:p(2,2)",160,0,218,4
	.export	DAC_DMA_Cmd
	.type	DAC_DMA_Cmd, @function
DAC_DMA_Cmd:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_dac.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,219,.LM56-.LFBB7
.LM56:
.LFBB7:
	SUB	sp,#8
	ST.w	[sp],r0
...
.Lscope7:
	...
	.align	1
	.stabs	"DAC_Output_Buffer_Config:F(0,15)",36,0,244,DAC_Output_Buffer_Config
	.stabs	"DACx:p(0,16)",160,0,244,0
	.stabs	"NewState:p(2,2)",160,0,244,4
	.export	DAC_Output_Buffer_Config
	.type	DAC_Output_Buffer_Config, @function
DAC_Output_Buffer_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_dac.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,245,.LM61-.LFBB8
.LM61:
.LFBB8:
	SUB	sp,#8
	ST.w	[sp],r0
	ST.w	[sp+#1],r1
	.stabn	68,0,250,.LM62-.LFBB8
.LM62:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L18
	.stabn	68,0,253,.LM63-.LFBB8
.LM63:
	LD.w	r5,[sp]
	ADD	r5,#12
// inline asm begin
...
.Lscope8:
	...
	.align	1
	.stabs	"DAC_Output_Port_Config:F(0,15)",36,0,270,DAC_Output_Port_Config
	.stabs	"DACx:p(0,16)",160,0,270,0
	.stabs	"NewState:p(2,2)",160,0,270,4
	.export	DAC_Output_Port_Config
	.type	DAC_Output_Port_Config, @function
DAC_Output_Port_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_dac.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,271,.LM66-.LFBB9
.LM66:
.LFBB9:
	SUB	sp,#8
	ST.w	[sp],r0
	ST.w	[sp+#1],r1
	.stabn	68,0,276,.LM67-.LFBB9
.LM67:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L21
	.stabn	68,0,279,.LM68-.LFBB9
.LM68:
	LD.w	r5,[sp]
	ADD	r5,#12
// inline asm begin
...
.Lscope9:
	...
	.align	1
	.stabs	"DAC_Write_Output_Data:F(0,15)",36,0,305,DAC_Write_Output_Data
	.stabs	"DACx:p(0,16)",160,0,305,0
	.stabs	"Value:p(3,6)",160,0,305,4
	.export	DAC_Write_Output_Data
	.type	DAC_Write_Output_Data, @function
DAC_Write_Output_Data:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_dac.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,306,.LM71-.LFBB10
.LM71:
.LFBB10:
	SUB	sp,#8
	ST.w	[sp],r0
	ST.w	[sp+#1],r1
	.stabn	68,0,311,.LM72-.LFBB10
.LM72:
	LD.w	r5,[sp]
	LD.w	r4,[sp+#1]
	ST.w	[r5+#1],r4
...
.Lscope10:
	...
	.align	1
	.stabs	"DAC_Read_Output_Data:F(3,6)",36,0,320,DAC_Read_Output_Data
	.stabs	"DACx:p(0,16)",160,0,320,0
	.export	DAC_Read_Output_Data
	.type	DAC_Read_Output_Data, @function
DAC_Read_Output_Data:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_dac.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,321,.LM74-.LFBB11
.LM74:
.LFBB11:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,325,.LM75-.LFBB11
.LM75:
	LD.w	r5,[sp]
	LD.w	r5,[r5+#2]
	MOV	r4,#0
...
.Lscope11:
	...
	.align	1
	.stabs	"DAC_Calibration_Config:F(0,15)",36,0,344,DAC_Calibration_Config
	.stabs	"DACx:p(0,16)",160,0,344,4
	.stabs	"dacCalStruct:p(0,18)=*(1,3)",160,0,344,8
	.export	DAC_Calibration_Config
	.type	DAC_Calibration_Config, @function
DAC_Calibration_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_dac.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,345,.LM77-.LFBB12
.LM77:
.LFBB12:
	PUSH	lr
	SUB	sp,#12
	ST.w	[sp+#1],r0
	ST.w	[sp+#2],r1
	.stabn	68,0,346,.LM78-.LFBB12
.LM78:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,361,.LM79-.LFBB12
.LM79:
	LD.w	r5,[sp+#2]
	LD.w	r5,[r5]
	MOV	r3,#28
	LSL	r4,r5,r3
	.stabn	68,0,362,.LM80-.LFBB12
.LM80:
	LD.w	r5,[sp+#2]
	LD.w	r5,[r5+#1]
	LSL	r5,#24
	.stabn	68,0,361,.LM81-.LFBB12
.LM81:
	ORL	r4,r4,r5
...
.LM82:
	...
	LD.w	r5,[r5+#2]
	LSL	r5,#20
	.stabn	68,0,362,.LM83-.LFBB12
.LM83:
	ORL	r4,r4,r5
	.stabn	68,0,364,.LM84-.LFBB12
.LM84:
	LD.w	r5,[sp+#2]
	LD.w	r5,[r5+#3]
	LSL	r5,#16
	.stabn	68,0,363,.LM85-.LFBB12
.LM85:
	ORL	r4,r4,r5
	.stabn	68,0,365,.LM86-.LFBB12
.LM86:
	LD.w	r5,[sp+#2]
	LD.w	r5,[r5+#4]
	LSL	r5,#15
	.stabn	68,0,361,.LM87-.LFBB12
.LM87:
	ORL	r5,r4,r5
	ST.w	[sp],r5
	.stabn	68,0,366,.LM88-.LFBB12
.LM88:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#5]
	MOV	r0,r5
	...
	LD.w	r5,[sp+#1]
	ST.w	[r5+#5],r4
	.stabn	68,0,367,.LM89-.LFBB12
.LM89:
	ADD	sp,#12
	POP	lr
	JMP	lr
	.size	DAC_Calibration_Config, .-DAC_Calibration_Config
	.stabs	"tmpreg:(3,6)",128,0,346,0
...
.Lscope12:
	...
	.align	1
	.stabs	"DAC_Calibration_Struct_Init:F(0,15)",36,0,375,DAC_Calibration_Struct_Init
	.stabs	"dacCalStruct:p(0,18)",160,0,375,0
	.export	DAC_Calibration_Struct_Init
	.type	DAC_Calibration_Struct_Init, @function
DAC_Calibration_Struct_Init:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_dac.c",132,0,0,.Ltext13
.Ltext13:
	.stabn	68,0,376,.LM90-.LFBB13
.LM90:
.LFBB13:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,378,.LM91-.LFBB13
.LM91:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5],r4
	.stabn	68,0,380,.LM92-.LFBB13
.LM92:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#1],r4
	.stabn	68,0,382,.LM93-.LFBB13
.LM93:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#2],r4
	.stabn	68,0,384,.LM94-.LFBB13
.LM94:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#3],r4
	.stabn	68,0,386,.LM95-.LFBB13
.LM95:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#4],r4
	.stabn	68,0,387,.LM96-.LFBB13
.LM96:
	ADD	sp,#4
	JMP	lr
