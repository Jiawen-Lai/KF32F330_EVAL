...
# 15 "D:\\workspace32\\KF32Fxxx_StdPeriph_Lib_V2.3\\inc/kf32f_basic_usb.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 19 "../src/kf32f_basic_usb.c" 2
# 1 "C:/Program Files (x86)/ChipON IDE/KungFu32/ChiponCC32/include/Sys/string.h" 1
# 21 "C:/Program Files (x86)/ChipON IDE/KungFu32/ChiponCC32/include/Sys/string.h"
extern int ffs (int);
...
# 20 "../src/kf32f_basic_usb.c" 2
# 51 "../src/kf32f_basic_usb.c"
void
USB_Reset(void)
{

    RST_CTL1_Peripheral_Reset_Enable(((uint32_t)1<<((31))), TRUE);
    RST_CTL1_Peripheral_Reset_Enable(((uint32_t)1<<((31))), FALSE);


    PCLK_CTL1_Peripheral_Clock_Enable(((uint32_t)1<<((31))), TRUE);
}
...
USB_Configuration(USB_InitTypeDef* usbInitStruct)
{
    ...
    tmpreg = usbInitStruct->m_Speed
           | ((uint32_t)usbInitStruct->m_Pullup << (2))
           | usbInitStruct->m_DoubleBufferCfg
           | ((uint32_t)usbInitStruct->m_DoubleBufferRst << (14));
    (((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON) = SFR_Config ((((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON), ~(((uint32_t)1<<((4))) | ((uint32_t)1<<((2))) | ((uint32_t)3<<((0)))), tmpreg);

    if (usbInitStruct->m_DoubleBufferRst != FALSE)
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON))),"i"((14)));
    }
    else
    {
        ;
    ...
    tmpreg = ((uint32_t)usbInitStruct->m_Handshake << (4))
           | ((uint32_t)usbInitStruct->m_Bidirectional << (3))
           | ((uint32_t)usbInitStruct->m_Output << (2))
           | ((uint32_t)usbInitStruct->m_Input << (1));
    tmpreg1 = usbInitStruct->m_EndPointMask;
    for (i = 0; i <= ((uint32_t)7); i++)
    {
        if (tmpreg1 & 0x1)
        {
            ((USB_SFRmap *) ((uint32_t)0x40000F80))->UEP[i] = SFR_Config (((USB_SFRmap *) ((uint32_t)0x40000F80))->UEP[i],
                                    ~(((uint32_t)1<<((4))) | ((uint32_t)1<<((3))) | ((uint32_t)1<<((2))) | ((uint32_t)1<<((1)))),
                                    tmpreg);
        }
        else
        {
...
# 169 "../src/kf32f_basic_usb.c"
    tmpreg &= ((uint32_t)3<<((0)));
    tmpreg >>= (0);

    tmpreg1 &= ((uint32_t)0xFF<<((8)));
    tmpreg1 >>= (8);

    tmpreg = (tmpreg << ((15) + 1)) | (tmpreg1);


    tmpreg = ((uint32_t)usbInitStruct->m_BufferAddr << (16))
           | tmpreg
           | (usbInitStruct->m_Own << (7))
           | usbInitStruct->m_DataToggleSync
           | ((uint32_t)usbInitStruct->m_DataToggleSyncEn << (3))
           | ((uint32_t)usbInitStruct->m_BufferStall << (2));

    *(volatile uint32_t *) tmpaddr =
                    SFR_Config (*(volatile uint32_t *) tmpaddr,
                            ~(((uint32_t)0xFFFF<<((16))) | ((((uint32_t)0xFF<<((8)))) | (((uint32_t)3<<((0))))) | ((uint32_t)1<<((7))) | ((uint32_t)1<<((6))) | ((uint32_t)1<<((3))) | ((uint32_t)1<<((2)))),
                            tmpreg);
}
...
USB_Struct_Init (USB_InitTypeDef* usbInitStruct)
{
    ...
    usbInitStruct->m_Speed = ((uint32_t)0<<(4));


    usbInitStruct->m_Pullup = FALSE;


    usbInitStruct->m_DoubleBufferCfg = ((uint32_t)0<<(0));


    usbInitStruct->m_EndPointMask = ((uint32_t)0);
...
USB_Buffer_Struct_Init (USB_BufferTypeDef* usbInitStruct)
{
    ...
    usbInitStruct->m_EndPoint = ((uint32_t)0);


    usbInitStruct->m_Direction = ((uint32_t)0);


    usbInitStruct->m_BDPointer = ((uint32_t)1);
    ...
    usbInitStruct->m_Own = ((uint32_t)0<<(7));


    usbInitStruct->m_DataToggleSync = ((uint32_t)0<<(6));
...
USB_Double_Buffer_Pointer_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON))),"i"((14)));
    }
    else
    {
...
USB_Get_Single_Ended_0_Flag (void)
{
    ...
    if (((uint32_t)1<<((13))) & (((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON))
    {
...
USB_Clear_Single_Ended_0_Flag (void)
{
 ...
 while(((uint32_t)1<<((13))) & (((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON))
 {
  __asm volatile("CLR [%0], #%1"::"r"(&((((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON))),"i"((13)));
 }
}
...
USB_Get_Package_Transmit_Flag (void)
{
    ...
    if (((uint32_t)1<<((12))) & (((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON))
    {
...
USB_Clear_Package_Transmit_Flag (void)
{
 ...
 while(((uint32_t)1<<((12))) & (((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON))
 {
  __asm volatile("CLR [%0], #%1"::"r"(&((((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON))),"i"((12)));
 }
}
...
USB_Suspend_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON))),"i"((11)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON))),"i"((11)));
    }
}
...
USB_Resume_Signal_Transmit_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON))),"i"((10)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON))),"i"((10)));
    }
}
...
USB_Cmd (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON))),"i"((9)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON))),"i"((9)));
    }
}
...
USB_Eye_Test_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON))),"i"((7)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON))),"i"((7)));
    }
}
# 467 "../src/kf32f_basic_usb.c"
void
USB_Speed_Config (uint32_t SpeedSelect)
{
    ...
    if (SpeedSelect != ((uint32_t)0<<(4)))
    {

        __asm volatile("SET [%0], #%1"::"r"(&((((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON))),"i"((4)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON))),"i"((4)));
    }
}
...
USB_On_Chip_Pull_Up_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON))),"i"((2)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON))),"i"((2)));
    }
}
# 519 "../src/kf32f_basic_usb.c"
void
USB_Double_Buffer_Config (uint32_t DoubleBuffer)
{
    ...
    (((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON) = SFR_Config ((((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON), ~((uint32_t)3<<((0))), DoubleBuffer);
}
...
USB_Get_Arrangement_State (USB_StateTypeDef* usbStateStruct)
{
    ...
    tmpreg = (((USB_SFRmap *) ((uint32_t)0x40000F80))->USTAT);



    tmpreg1 = tmpreg & ((uint32_t)0xF<<((3)));
    tmpreg1 >>= (3);
    usbStateStruct->m_EndPoint = tmpreg1;


    tmpreg1 = tmpreg & ((uint32_t)1<<((2)));
    tmpreg1 >>= (2);
    usbStateStruct->m_BDDirection = tmpreg1;


    tmpreg1 = tmpreg & ((uint32_t)1<<((1)));
    tmpreg1 >>= (1);
...
USB_Address_Config (uint32_t Address)
{
 uint32_t tmpreg = 0;
    ...
    tmpreg = Address << (0);
    (((USB_SFRmap *) ((uint32_t)0x40000F80))->UADDR) = SFR_Config ((((USB_SFRmap *) ((uint32_t)0x40000F80))->UADDR), ~((uint32_t)0x7F<<((0))), tmpreg);
}
...
USB_Get_Address (void)
{
    ...
    tmpreg = (((USB_SFRmap *) ((uint32_t)0x40000F80))->UADDR);
    tmpreg &= ((uint32_t)0x7F<<((0)));
    tmpreg >>= (0);
...
USB_Get_Frame_Num (void)
{
    ...
    tmpreg = (((USB_SFRmap *) ((uint32_t)0x40000F80))->UFRM);
    tmpreg &= ((uint32_t)0x7FF<<((0)));
    tmpreg >>= (0);
...
USB_Endpoint_Handshake_Enable (uint32_t EndPoint, FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(((USB_SFRmap *) ((uint32_t)0x40000F80))->UEP[EndPoint])),"i"((4)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(((USB_SFRmap *) ((uint32_t)0x40000F80))->UEP[EndPoint])),"i"((4)));
    }
}
...
USB_Bidirectional_Endpoint_Enable (uint32_t EndPoint, FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("CLR [%0], #%1"::"r"(&(((USB_SFRmap *) ((uint32_t)0x40000F80))->UEP[EndPoint])),"i"((3)));
    }
    else
    {

        __asm volatile("SET [%0], #%1"::"r"(&(((USB_SFRmap *) ((uint32_t)0x40000F80))->UEP[EndPoint])),"i"((3)));
    }
}
...
USB_Endpoint_Output_Enable (uint32_t EndPoint, FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(((USB_SFRmap *) ((uint32_t)0x40000F80))->UEP[EndPoint])),"i"((2)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(((USB_SFRmap *) ((uint32_t)0x40000F80))->UEP[EndPoint])),"i"((2)));
    }
}
...
USB_Endpoint_Input_Enable (uint32_t EndPoint, FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(((USB_SFRmap *) ((uint32_t)0x40000F80))->UEP[EndPoint])),"i"((1)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(((USB_SFRmap *) ((uint32_t)0x40000F80))->UEP[EndPoint])),"i"((1)));
    }
}
...
USB_Get_Endpoint_STALL_Flag (uint32_t EndPoint)
{
    ...
    if (((USB_SFRmap *) ((uint32_t)0x40000F80))->UEP[EndPoint] & ((uint32_t)1<<((0))))
    {
...
USB_Clear_Endpoint_STALL_Flag (uint32_t EndPoint)
{
    ...
    while(((USB_SFRmap *) ((uint32_t)0x40000F80))->UEP[EndPoint] & ((uint32_t)1<<((0))))
    {
     __asm volatile("CLR [%0], #%1"::"r"(&(((USB_SFRmap *) ((uint32_t)0x40000F80))->UEP[EndPoint])),"i"((0)));
    }
}
...
USB_Debug_Signal_Output_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((USB_SFRmap *) ((uint32_t)0x40000F80))->UDB))),"i"((4)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((USB_SFRmap *) ((uint32_t)0x40000F80))->UDB))),"i"((4)));
    }
}
# 800 "../src/kf32f_basic_usb.c"
void
USB_Debug_Output_Config (uint32_t DebugCtl)
{
    ...
    (((USB_SFRmap *) ((uint32_t)0x40000F80))->UDB) = SFR_Config ((((USB_SFRmap *) ((uint32_t)0x40000F80))->UDB), ~((uint32_t)7<<((0))), DebugCtl);
}
# 829 "../src/kf32f_basic_usb.c"
uint32_t
                    ...
                    uint32_t Direction, uint32_t BufferDescripor)
{
    ...
    tmpreg = (((USB_SFRmap *) ((uint32_t)0x40000F80))->UCON);
    tmpreg &= ((uint32_t)3<<((0)));
    ...
    switch (tmpreg)
    {
        ...
        case ((uint32_t)1<<(0)):
        {
            if (EndPoint != ((uint32_t)0))
            {

                tmpaddr = ((uint32_t)0x1FFEFC00) + (4 * 3);
            ...
            else
            {
                ...
                else
                {
                    ...
                    tmpaddr = ((uint32_t)0x1FFEFC00) + (4 * 2);
                }
            }
        }
            break;
...
USB_Get_Buffer_Address (uint32_t SfrAddr)
{
    ...
    tmpreg &= ((uint32_t)0xFFFF<<((16)));
    tmpreg >>= (16);

    return tmpreg;
}
# 974 "../src/kf32f_basic_usb.c"
void
USB_Buffer_Data_Length_Config (uint32_t SfrAddr, uint32_t ByteLength)
{
    ...
    tmpaddr = SfrAddr;
    tmpreg = ((ByteLength >> 8) & ((uint32_t)3<<((0)))) << (0);
    tmpreg |= (ByteLength & 0xFF) << (8);
    *(volatile uint32_t *) tmpaddr =
                    SFR_Config (*(volatile uint32_t *) tmpaddr,
                            ~((((uint32_t)0xFF<<((8)))) | (((uint32_t)3<<((0))))),
                            tmpreg);
}
...
USB_Own_Config (uint32_t SfrAddr, uint32_t OwnSelect)
{
    ...
    tmpaddr = SfrAddr;
    if (OwnSelect != ((uint32_t)0<<(7)))
    {

        __asm volatile("SET [%0], #%1"::"r"(&(*(volatile uint32_t *) tmpaddr)),"i"((7)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(*(volatile uint32_t *) tmpaddr)),"i"((7)));
    }
}
# 1065 "../src/kf32f_basic_usb.c"
FlagStatus
USB_Get_Own_Status (uint32_t SfrAddr)
{
    ...
    tmpaddr = SfrAddr;
    if (((uint32_t)1<<((7))) & (*(volatile uint32_t *) tmpaddr))
    {
...
USB_Data_Toggle_Sync_Config (uint32_t SfrAddr, uint32_t DataPackage)
{
    ...
    tmpaddr = SfrAddr;
    if (DataPackage != ((uint32_t)0<<(6)))
    {

        __asm volatile("SET [%0], #%1"::"r"(&(*(volatile uint32_t *) tmpaddr)),"i"((6)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(*(volatile uint32_t *) tmpaddr)),"i"((6)));
    }
}
# 1128 "../src/kf32f_basic_usb.c"
FlagStatus
USB_Get_Data_Toggle_Sync_Status (uint32_t SfrAddr)
{
    ...
    tmpaddr = SfrAddr;
    if (((uint32_t)1<<((6))) & (*(volatile uint32_t *) tmpaddr))
    {
...
USB_Data_Toggle_Sync_Enable (uint32_t SfrAddr, FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(*(volatile uint32_t *) tmpaddr)),"i"((3)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(*(volatile uint32_t *) tmpaddr)),"i"((3)));
    }
}
# 1189 "../src/kf32f_basic_usb.c"
void
USB_Buffer_Stall_Enable (uint32_t SfrAddr, FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(*(volatile uint32_t *) tmpaddr)),"i"((2)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(*(volatile uint32_t *) tmpaddr)),"i"((2)));
    }
}
...
USB_Get_Last_Receive_PID (uint32_t SfrAddr)
{
    ...
    tmpaddr = SfrAddr;
    tmpreg = *(volatile uint32_t *) tmpaddr;
    tmpreg &= ((uint32_t)0xF<<((2)));
    tmpreg >>= (2);

    return tmpreg;
}
# 1245 "../src/kf32f_basic_usb.c"
void
...
USB_Get_INT_Flag (uint32_t InterruptType)
{
    ...
    if ((((USB_SFRmap *) ((uint32_t)0x40000F80))->UIR) & InterruptType)
    {
...
USB_Clear_INT_Flag (uint32_t InterruptType)
{
    ...
    while((((USB_SFRmap *) ((uint32_t)0x40000F80))->UIR) & InterruptType)
    {
     (((USB_SFRmap *) ((uint32_t)0x40000F80))->UIR) &= ~InterruptType;
    }
}
# 1350 "../src/kf32f_basic_usb.c"
void
USB_Set_INT_Enable (uint32_t InterruptType, FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        (((USB_SFRmap *) ((uint32_t)0x40000F80))->UIE) |= InterruptType;
    }
    else
    {
...
USB_Get_INT_Enable (uint32_t InterruptType)
{
    ...
    if ((((USB_SFRmap *) ((uint32_t)0x40000F80))->UIE) & InterruptType)
    {
