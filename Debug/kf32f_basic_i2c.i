...
# 16 "D:\\workspace32\\KF32Fxxx_StdPeriph_Lib_V2.3\\inc/kf32f_basic_i2c.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 18 "../src/kf32f_basic_i2c.c" 2
# 38 "../src/kf32f_basic_i2c.c"
void
I2C_Reset (I2C_SFRmap* I2Cx)
{
    ...
    if (I2Cx == ((I2C_SFRmap *) ((uint32_t)0x40000D00)))
    {
        RST_CTL1_Peripheral_Reset_Enable(((uint32_t)1<<((26))), TRUE);
        RST_CTL1_Peripheral_Reset_Enable(((uint32_t)1<<((26))), FALSE);
        PCLK_CTL1_Peripheral_Clock_Enable(((uint32_t)1<<((26))), TRUE);
    }


    if (I2Cx == ((I2C_SFRmap *) ((uint32_t)0x40000D80)))
    {
        RST_CTL1_Peripheral_Reset_Enable(((uint32_t)1<<((27))), TRUE);
        RST_CTL1_Peripheral_Reset_Enable(((uint32_t)1<<((27))), FALSE);
        PCLK_CTL1_Peripheral_Clock_Enable(((uint32_t)1<<((27))), TRUE);
    }


    if (I2Cx == ((I2C_SFRmap *) ((uint32_t)0x40000E00)))
    {
        RST_CTL1_Peripheral_Reset_Enable(((uint32_t)1<<((28))), TRUE);
        RST_CTL1_Peripheral_Reset_Enable(((uint32_t)1<<((28))), FALSE);
        PCLK_CTL1_Peripheral_Clock_Enable(((uint32_t)1<<((28))), TRUE);
    }


    if (I2Cx == ((I2C_SFRmap *) ((uint32_t)0x40002380)))
    {
        RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((7))), TRUE);
        RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((7))), FALSE);
        PCLK_CTL3_Peripheral_Clock_Enable(((uint32_t)1<<((7))), TRUE);
    }
...
# 105 "../src/kf32f_basic_i2c.c"
 tmpreg = ((i2cInitStruct->m_Mode)
   ...
   | (i2cInitStruct->m_AckData));
    I2Cx->CTLR = SFR_Config (I2Cx->CTLR, ~(((uint32_t)1<<((24))) | ((uint32_t)3<<((16))) | ((uint32_t)1<<((1))) | ((uint32_t)1<<((25))) | ((uint32_t)1<<((12))) | ((uint32_t)1<<((13)))), tmpreg);




    tmpreg = ((i2cInitStruct->m_BaudRateL << (16))
            | (i2cInitStruct->m_BaudRateH << (0)));
    I2Cx->BRGR = SFR_Config (I2Cx->BRGR,
                        ~(((uint32_t)0xFFFF<<((16))) | ((uint32_t)0xFFFF<<((0)))),
                        tmpreg);
}
...
void I2C_Struct_Init (I2C_InitTypeDef* I2C_InitStruct)
{
    ...
    I2C_InitStruct->m_Mode = ((uint32_t)0<<(24));


    I2C_InitStruct->m_ClockSource = ((uint32_t)0<<(16));


    I2C_InitStruct->m_BADR10 = ((uint32_t)0<<(1));


    I2C_InitStruct->m_MasterSlave = ((uint32_t)0<<(25));
    ...
    I2C_InitStruct->m_AckData = ((uint32_t)0<<(13));
}
# 168 "../src/kf32f_basic_i2c.c"
void
I2C_Cmd(I2C_SFRmap* I2Cx, FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((0)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((0)));
    }
}
# 195 "../src/kf32f_basic_i2c.c"
void
I2C_Bufr_Address_Config(I2C_SFRmap* I2Cx, uint32_t NewState)
{
    ...
    if (NewState != ((uint32_t)0<<(1)))
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((1)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((1)));
    }
}
...
I2C_Generate_START(I2C_SFRmap* I2Cx, FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((8)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((8)));
    }
}
...
I2C_Generate_STOP(I2C_SFRmap* I2Cx, FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((10)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((10)));
    }
}
...
I2C_Ack_Config (I2C_SFRmap* I2Cx, FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((12)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((12)));
    }
}
# 301 "../src/kf32f_basic_i2c.c"
void
I2C_Ack_DATA_Config (I2C_SFRmap* I2Cx, uint32_t NewState)
{
    ...
    if (NewState != ((uint32_t)0<<(13)))
    {

        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((13)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((13)));
    }
}
...
I2C_Call_Cmd (I2C_SFRmap* I2Cx, FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((14)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((14)));
    }
}
# 355 "../src/kf32f_basic_i2c.c"
void
I2C_Clock_Config (I2C_SFRmap* I2Cx,uint32_t ClkSource)
{
    ...
    I2Cx->CTLR = SFR_Config (I2Cx->CTLR, ~((uint32_t)3<<((16))), ClkSource);
}
...
I2C_MATCH_ADDRESS_Config (I2C_SFRmap* I2Cx, FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((20)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((20)));
    }
}
...
I2C_SCL_Enable (I2C_SFRmap* I2Cx, FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((21)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((21)));
    }
}
...
I2C_NMENA_Enable(I2C_SFRmap* I2Cx, FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((22)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((22)));
    }
}
# 452 "../src/kf32f_basic_i2c.c"
void
I2C_SMBUS_Enable(I2C_SFRmap* I2Cx, uint32_t NewState)
{
    ...
    if (NewState != ((uint32_t)0<<(24)))
    {

        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((24)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((24)));
    }
}
# 480 "../src/kf32f_basic_i2c.c"
void
I2C_SMBT_Config(I2C_SFRmap* I2Cx, uint32_t NewState)
{
    ...
    if (NewState != ((uint32_t)0<<(25)))
    {

        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((25)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((25)));
    }
}
...
I2C_SMBus_ALERT_Config(I2C_SFRmap* I2Cx, FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((27)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((27)));
    }
}
...
I2C_ARP_Enable(I2C_SFRmap* I2Cx, FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((26)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->CTLR)),"i"((26)));
    }
}
# 613 "../src/kf32f_basic_i2c.c"
void
...
I2C_BRGH_Config (I2C_SFRmap* I2Cx,uint16_t Period)
{
    ...
    tmpreg = (uint32_t)Period << (0);
    I2Cx->BRGR = SFR_Config (I2Cx->BRGR, ~((uint32_t)0xFFFF<<((0))), tmpreg);
}
...
I2C_BRGL_Config (I2C_SFRmap* I2Cx,uint16_t Period)
{
    ...
    tmpreg = (uint32_t)Period << (16);
    I2Cx->BRGR = SFR_Config (I2Cx->BRGR, ~((uint32_t)0xFFFF<<((16))), tmpreg);
}
# 726 "../src/kf32f_basic_i2c.c"
void
I2C_Start_INT_Enable (I2C_SFRmap* I2Cx,FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->IER)),"i"((0)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->IER)),"i"((0)));
    }
}
...
I2C_Stop_INT_Enable (I2C_SFRmap* I2Cx,FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->IER)),"i"((1)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->IER)),"i"((1)));
    }
}
...
I2C_Ack_Fail_INT_Enable (I2C_SFRmap* I2Cx,FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->IER)),"i"((5)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->IER)),"i"((5)));
    }
}
...
I2C_Arbitration_Lost_INT_Enable (I2C_SFRmap* I2Cx,FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->IER)),"i"((6)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->IER)),"i"((6)));
    }
}
...
I2C_SMBus_Alert_INT_Enable (I2C_SFRmap* I2Cx,FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->IER)),"i"((8)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->IER)),"i"((8)));
    }
}
...
I2C_SMBus_HostHead_INT_Enable (I2C_SFRmap* I2Cx,FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->IER)),"i"((9)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->IER)),"i"((9)));
    }
}
                    ...
                    FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->IER)),"i"((10)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->IER)),"i"((10)));
    }
}
...
I2C_ISIE_INT_Enable (I2C_SFRmap* I2Cx,FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->IER)),"i"((11)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->IER)),"i"((11)));
    }
}
...
I2C_Receive_DMA_INT_Enable (I2C_SFRmap* I2Cx,FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->IER)),"i"((16)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->IER)),"i"((16)));
    }
}
...
I2C_Transmit_DMA_INT_Enable (I2C_SFRmap* I2Cx,FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->IER)),"i"((17)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->IER)),"i"((17)));
    }
}
...
I2C_Clear_Start_Flag (I2C_SFRmap* I2Cx)
{
    ...
    while(((I2Cx->SR) & ((uint32_t)1<<((0))))>>(0))
    {
     __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->SR)),"i"((0)));
    }
}
...
I2C_Clear_Stop_Flag (I2C_SFRmap* I2Cx)
{
    ...
    while(((I2Cx->SR) & ((uint32_t)1<<((1))))>>(1))
    {
     __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->SR)),"i"((1)));
    }
...
I2C_Clear_Ack_Fail_Flag (I2C_SFRmap* I2Cx)
{
    ...
    while(((I2Cx->SR) & ((uint32_t)1<<((5))))>>(5))
    {
     __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->SR)),"i"((5)));
    }
}
...
I2C_Clear_Arbitration_Lost_Flag (I2C_SFRmap* I2Cx)
{
    ...
    while(((I2Cx->SR) & ((uint32_t)1<<((6))))>>(6))
    {
     __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->SR)),"i"((6)));
    }
}
...
I2C_Clear_SMBus_Alert_Flag (I2C_SFRmap* I2Cx)
{
    ...
    while(((I2Cx->SR) & ((uint32_t)1<<((8))))>>(8))
    {
     __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->SR)),"i"((8)));
    }
}
...
I2C_Clear_SMBus_Host_Header_Flag (I2C_SFRmap* I2Cx)
{
    ...
    while(((I2Cx->SR) & ((uint32_t)1<<((9))))>>(9))
    {
     __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->SR)),"i"((9)));
    }
}
...
I2C_Clear_SMBus_Device_Default_Flag (I2C_SFRmap* I2Cx)
{
    ...
    while(((I2Cx->SR) & ((uint32_t)1<<((10))))>>(10))
    {
     __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->SR)),"i"((10)));
    }
}
...
I2C_Clear_INTERRUPT_Flag (I2C_SFRmap* I2Cx)
{
    ...
    while(((I2Cx->SR) & ((uint32_t)1<<((11))))>>(11))
    {
     __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->SR)),"i"((11)));
