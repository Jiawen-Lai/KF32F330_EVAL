...
# 15 "D:\\workspace32\\KF32Fxxx_StdPeriph_Lib_V2.3\\inc/kf32f_basic_systick.h" 2
...
# 15 "../src/kf32f_basic_systick.c" 2
# 42 "../src/kf32f_basic_systick.c"
void
                    ...
                    uint32_t Reload)
{
    ...
    __asm volatile("CLR [%0], #%1"::"r"(&((((SYSTICK_SFRmap *) ((uint32_t)0x402000A0))->CTL))),"i"((0)));


    (((SYSTICK_SFRmap *) ((uint32_t)0x402000A0))->RELOAD) = Reload;
    ...
    tmpreg = Clock | (SysTickINT << (1));
    (((SYSTICK_SFRmap *) ((uint32_t)0x402000A0))->CTL) = SFR_Config ((((SYSTICK_SFRmap *) ((uint32_t)0x402000A0))->CTL),
                          ~(((uint32_t)1<<((1))) | ((uint32_t)1<<((2)))),
                          tmpreg);
}
# 86 "../src/kf32f_basic_systick.c"
void
SYSTICK_Cmd (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((SYSTICK_SFRmap *) ((uint32_t)0x402000A0))->CTL))),"i"((0)));
    }
    else
    {
...
SYSTICK_Clock_Config (uint32_t SysClock)
{
    ...
    if (SysClock != ((uint32_t)0x0 << (2)))
    {

        __asm volatile("SET [%0], #%1"::"r"(&((((SYSTICK_SFRmap *) ((uint32_t)0x402000A0))->CTL))),"i"((2)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((SYSTICK_SFRmap *) ((uint32_t)0x402000A0))->CTL))),"i"((2)));
    }
}
...
SYSTICK_Systick_INT_Enable (uint32_t SysClock)
{
    ...
    if (SysClock != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((SYSTICK_SFRmap *) ((uint32_t)0x402000A0))->CTL))),"i"((1)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((SYSTICK_SFRmap *) ((uint32_t)0x402000A0))->CTL))),"i"((1)));
    }
}
...
SYSTICK_Get_Count_Zero_Flag (ATIM_SFRmap* ATIMx)
{
    ...
    if ((((SYSTICK_SFRmap *) ((uint32_t)0x402000A0))->CTL) & ((uint32_t)1<<((16))))
    {
...
SYSTICK_Get_Reload (void)
{
    ...
    tmpreg = (((SYSTICK_SFRmap *) ((uint32_t)0x402000A0))->RELOAD) & ((uint32_t)0x00FFFFFF<<((0)));
...
SYSTICK_Get_Counter (void)
{
    ...
    tmpreg = (((SYSTICK_SFRmap *) ((uint32_t)0x402000A0))->CV) & ((uint32_t)0x00FFFFFF<<((0)));
