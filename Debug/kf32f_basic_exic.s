	...
	.stabs	"../src/kf32f_basic_exic.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.stabn	162,0,0,0
	.stabs	"EXIC_InitTypeDef:t(1,1)=(1,2)=s60m_Module_Enable:(2,2),0,32;m_CS_Enable:(2,2),32,32;m_Data_Control_Sel:(3,6),64,32;m_Write_Enable:(2,2),96,32;m_Read_Enable:(2,2),128,32;m_DMA_Write_EN:(2,2),160,32;m_DMA_Read_EN:(2,2),192,32;m_WriteFnish_INT_EN:(2,2),224,32;m_ReadFnish_INT_EN:(2,2),256,32;m_WriteData_EN:(2,2),288,32;m_ReadData_EN:(2,2),320,32;m_Data_Direction_Sel:(3,6),352,32;m_Mode_Sel:(3,6),384,32;m_Source_Clock_Sel:(3,6),416,32;m_Pulse_Width_Sel:(3,6),448,32;;",128,0,55,0
	.stabn	162,0,0,0
...
.Lscope1:
	...
	.align	1
	.stabs	"EXIC_Reset:F(0,15)",36,0,46,EXIC_Reset
	.export	EXIC_Reset
	.type	EXIC_Reset, @function
EXIC_Reset:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_exic.c",132,0,0,.Ltext2
.Ltext2:
	.stabn	68,0,47,.LM3-.LFBB2
.LM3:
.LFBB2:
	PUSH	lr
...
.Lscope2:
	...
	.align	1
	.stabs	"EXIC_Configuration:F(0,15)",36,0,58,EXIC_Configuration
	.stabs	"EXICInitStruct:p(0,16)=*(1,1)",160,0,58,4
	.export	EXIC_Configuration
	.type	EXIC_Configuration, @function
EXIC_Configuration:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_exic.c",132,0,0,.Ltext3
.Ltext3:
	.stabn	68,0,59,.LM8-.LFBB3
.LM8:
.LFBB3:
	PUSH	{r6, lr}
	SUB	sp,#8
	ST.w	[sp+#1],r0
	.stabn	68,0,60,.LM9-.LFBB3
.LM9:
	MOV	r5,#0
	ST.w	[sp],r5
...
.LM10:
	LD.w	r5,[sp+#1]
	LD.w	r4,[r5]
	.stabn	68,0,95,.LM11-.LFBB3
.LM11:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#1]
	ADD	r5,r5,r5
	.stabn	68,0,94,.LM12-.LFBB3
.LM12:
	ORL	r4,r4,r5
	.stabn	68,0,96,.LM13-.LFBB3
.LM13:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#2]
...
.LM14:
	ORL	r4,r4,r5
	.stabn	68,0,97,.LM15-.LFBB3
.LM15:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#3]
	LSL	r5,#3
	.stabn	68,0,96,.LM16-.LFBB3
.LM16:
	ORL	r4,r4,r5
	.stabn	68,0,98,.LM17-.LFBB3
.LM17:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#4]
	LSL	r5,#4
	.stabn	68,0,97,.LM18-.LFBB3
.LM18:
	ORL	r4,r4,r5
	.stabn	68,0,99,.LM19-.LFBB3
.LM19:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#5]
	LSL	r5,#8
	.stabn	68,0,98,.LM20-.LFBB3
.LM20:
	ORL	r4,r4,r5
	.stabn	68,0,100,.LM21-.LFBB3
.LM21:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#6]
	LSL	r5,#9
	.stabn	68,0,99,.LM22-.LFBB3
.LM22:
	ORL	r4,r4,r5
	.stabn	68,0,101,.LM23-.LFBB3
.LM23:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#7]
	LSL	r5,#16
	.stabn	68,0,100,.LM24-.LFBB3
.LM24:
	ORL	r4,r4,r5
...
.LM26:
	ORL	r4,r4,r5
	.stabn	68,0,103,.LM27-.LFBB3
.LM27:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#9]
	LSL	r5,#28
	.stabn	68,0,102,.LM28-.LFBB3
.LM28:
	ORL	r4,r4,r5
...
.LM31:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#11]
	.stabn	68,0,104,.LM32-.LFBB3
.LM32:
	ORL	r4,r4,r5
	.stabn	68,0,106,.LM33-.LFBB3
.LM33:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#12]
	.stabn	68,0,105,.LM34-.LFBB3
.LM34:
	ORL	r4,r4,r5
	.stabn	68,0,107,.LM35-.LFBB3
.LM35:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#13]
	.stabn	68,0,106,.LM36-.LFBB3
.LM36:
	ORL	r4,r4,r5
...
.LM37:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#14]
	.stabn	68,0,94,.LM38-.LFBB3
.LM38:
	ORL	r5,r4,r5
	ST.w	[sp],r5
	.stabn	68,0,109,.LM39-.LFBB3
.LM39:
	LD	r6,#1073752064
	LD	r5,#1073752064
	LD.w	r5,[r5]
	...
	MOV	r5,r0
	ST.w	[r6],r5
	.stabn	68,0,115,.LM40-.LFBB3
.LM40:
	LD.w	r5,[sp+#1]
	LD.w	r4,[r5+#13]
	.stabn	68,0,116,.LM41-.LFBB3
.LM41:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#14]
	.stabn	68,0,115,.LM42-.LFBB3
.LM42:
	ORL	r5,r4,r5
	ST.w	[sp],r5
	.stabn	68,0,117,.LM43-.LFBB3
.LM43:
	LD	r6,#1073752064
	LD	r5,#1073752064
	LD.w	r5,[r5+#1]
	...
	MOV	r5,r0
	ST.w	[r6+#1],r5
	.stabn	68,0,120,.LM44-.LFBB3
.LM44:
	ADD	sp,#8
	POP	{r6, pc}
	.size	EXIC_Configuration, .-EXIC_Configuration
	.stabs	"tmpreg:(3,6)",128,0,60,0
...
.Lscope3:
	...
	.align	1
	.stabs	"EXIC_Struct_Init:F(0,15)",36,0,127,EXIC_Struct_Init
	.stabs	"EXICInitStruct:p(0,16)",160,0,127,0
	.export	EXIC_Struct_Init
	.type	EXIC_Struct_Init, @function
EXIC_Struct_Init:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_exic.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,128,.LM45-.LFBB4
.LM45:
.LFBB4:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,130,.LM46-.LFBB4
.LM46:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5],r4
...
.LM47:
	...
	MOV	r4,#0
	ST.w	[r5+#1],r4
	.stabn	68,0,134,.LM48-.LFBB4
.LM48:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#2],r4
	.stabn	68,0,136,.LM49-.LFBB4
.LM49:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#3],r4
	.stabn	68,0,138,.LM50-.LFBB4
.LM50:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#4],r4
	.stabn	68,0,140,.LM51-.LFBB4
.LM51:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#5],r4
	.stabn	68,0,142,.LM52-.LFBB4
.LM52:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#6],r4
	.stabn	68,0,144,.LM53-.LFBB4
.LM53:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#7],r4
	.stabn	68,0,146,.LM54-.LFBB4
.LM54:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#8],r4
	.stabn	68,0,148,.LM55-.LFBB4
.LM55:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#9],r4
	.stabn	68,0,150,.LM56-.LFBB4
.LM56:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#10],r4
	.stabn	68,0,152,.LM57-.LFBB4
.LM57:
	LD.w	r4,[sp]
	MOV	r5,#1
	LSL	r5,#30
	ST.w	[r4+#11],r5
	.stabn	68,0,154,.LM58-.LFBB4
.LM58:
	LD.w	r4,[sp]
	MOV	r5,#1
	LSL	r5,#31
	ST.w	[r4+#12],r5
	.stabn	68,0,156,.LM59-.LFBB4
.LM59:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#13],r4
	.stabn	68,0,158,.LM60-.LFBB4
.LM60:
	LD.w	r5,[sp]
	MOV	r4,#64
	ST.w	[r5+#14],r4
	.stabn	68,0,159,.LM61-.LFBB4
.LM61:
	ADD	sp,#4
	JMP	lr
...
.Lscope4:
	...
	.align	1
	.stabs	"EXIC_Get_Write_Finish_INT_Flag:F(2,4)",36,0,166,EXIC_Get_Write_Finish_INT_Flag
	.export	EXIC_Get_Write_Finish_INT_Flag
	.type	EXIC_Get_Write_Finish_INT_Flag, @function
EXIC_Get_Write_Finish_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_exic.c",132,0,0,.Ltext5
.Ltext5:
	.stabn	68,0,167,.LM62-.LFBB5
.LM62:
.LFBB5:
	.stabn	68,0,169,.LM63-.LFBB5
.LM63:
	LD	r5,#1073752064
	LD.w	r4,[r5+#2]
	MOV	r5,#1
	...
	CMP	r5,#0
	JZ	.L7
	.stabn	68,0,172,.LM64-.LFBB5
.LM64:
	MOV	r5,#1
	JMP	.L8
.L7:
	.stabn	68,0,177,.LM65-.LFBB5
.LM65:
	MOV	r5,#0
.L8:
	.stabn	68,0,179,.LM66-.LFBB5
.LM66:
	MOV	r0,r5
	JMP	lr
...
.Lscope5:
	...
	.align	1
	.stabs	"EXIC_Clear_Write_Finish_INT_Flag:F(0,15)",36,0,185,EXIC_Clear_Write_Finish_INT_Flag
	.export	EXIC_Clear_Write_Finish_INT_Flag
	.type	EXIC_Clear_Write_Finish_INT_Flag, @function
EXIC_Clear_Write_Finish_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_exic.c",132,0,0,.Ltext6
.Ltext6:
	.stabn	68,0,186,.LM67-.LFBB6
.LM67:
.LFBB6:
	.stabn	68,0,188,.LM68-.LFBB6
.LM68:
	JMP	.L10
.L11:
	.stabn	68,0,190,.LM69-.LFBB6
.LM69:
	LD	r5,#1073752064
	LD	r4,#1073752064
	LD.w	r4,[r4+#2]
...
.Lscope6:
	...
	.align	1
	.stabs	"EXIC_Get_Read_Finish_INT_Flag:F(2,4)",36,0,199,EXIC_Get_Read_Finish_INT_Flag
	.export	EXIC_Get_Read_Finish_INT_Flag
	.type	EXIC_Get_Read_Finish_INT_Flag, @function
EXIC_Get_Read_Finish_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_exic.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,200,.LM72-.LFBB7
.LM72:
.LFBB7:
	.stabn	68,0,202,.LM73-.LFBB7
.LM73:
	LD	r5,#1073752064
	LD.w	r4,[r5+#2]
	MOV	r5,#2
...
.Lscope7:
	...
	.align	1
	.stabs	"EXIC_Clear_Read_Finish_INT_Flag:F(0,15)",36,0,218,EXIC_Clear_Read_Finish_INT_Flag
	.export	EXIC_Clear_Read_Finish_INT_Flag
	.type	EXIC_Clear_Read_Finish_INT_Flag, @function
EXIC_Clear_Read_Finish_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_exic.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,219,.LM77-.LFBB8
.LM77:
.LFBB8:
	.stabn	68,0,221,.LM78-.LFBB8
.LM78:
	JMP	.L16
.L17:
	.stabn	68,0,223,.LM79-.LFBB8
.LM79:
	LD	r5,#1073752064
	LD	r4,#1073752064
	LD.w	r4,[r4+#2]
...
.Lscope8:
	...
	.align	1
	.stabs	"EXIC_Write_Buff:F(0,15)",36,0,233,EXIC_Write_Buff
	.stabs	"DATA:p(3,6)",160,0,233,0
	.export	EXIC_Write_Buff
	.type	EXIC_Write_Buff, @function
EXIC_Write_Buff:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_exic.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,234,.LM82-.LFBB9
.LM82:
.LFBB9:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,235,.LM83-.LFBB9
.LM83:
	LD	r5,#1073752064
	LD.w	r4,[sp]
	ST.w	[r5+#4],r4
	.stabn	68,0,236,.LM84-.LFBB9
.LM84:
	ADD	sp,#4
	JMP	lr
...
.Lscope9:
	...
	.align	1
	.stabs	"EXIC_Read_Buff:F(3,6)",36,0,243,EXIC_Read_Buff
	.export	EXIC_Read_Buff
	.type	EXIC_Read_Buff, @function
EXIC_Read_Buff:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_exic.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,244,.LM85-.LFBB10
.LM85:
.LFBB10:
	.stabn	68,0,246,.LM86-.LFBB10
.LM86:
	LD	r5,#1073752064
	LD.w	r5,[r5+#5]
	.stabn	68,0,248,.LM87-.LFBB10
.LM87:
	MOV	r0,r5
	JMP	lr
