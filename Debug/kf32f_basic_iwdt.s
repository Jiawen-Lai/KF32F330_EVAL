	...
	.stabs	"../src/kf32f_basic_iwdt.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.stabs	"D:\\workspace32\\KF32Fxxx_StdPeriph_Lib_V2.3\\inc/kf32f_basic_iwdt.h",130,0,0,0
...
.Lscope1:
	...
	.align	1
	.stabs	"IWDT_Prescaler_Config:F(0,15)",36,0,40,IWDT_Prescaler_Config
	.stabs	"Prescaler:p(3,6)",160,0,40,0
	.export	IWDT_Prescaler_Config
	.type	IWDT_Prescaler_Config, @function
IWDT_Prescaler_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_iwdt.c",132,0,0,.Ltext2
.Ltext2:
...
.Lscope2:
	...
	.align	1
	.stabs	"IWDT_Overflow_Config:F(0,15)",36,0,55,IWDT_Overflow_Config
	.stabs	"Overflow:p(3,6)",160,0,55,4
	.export	IWDT_Overflow_Config
	.type	IWDT_Overflow_Config, @function
IWDT_Overflow_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_iwdt.c",132,0,0,.Ltext3
.Ltext3:
...
.LFBB3:
	...
	SUB	sp,#8
	ST.w	[sp+#1],r0
	.stabn	68,0,57,.LM7-.LFBB3
.LM7:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,63,.LM8-.LFBB3
.LM8:
	LD.w	r5,[sp+#1]
	LSL	r5,#4
	ST.w	[sp],r5
	.stabn	68,0,64,.LM9-.LFBB3
.LM9:
	LD	r6,#1073746432
	LD	r5,#1073746432
	LD.w	r5,[r5]
...
.Lscope3:
	...
	.align	1
	.stabs	"IWDT_Enable:F(0,15)",36,0,73,IWDT_Enable
	.stabs	"NewState:p(2,2)",160,0,73,0
	.export	IWDT_Enable
	.type	IWDT_Enable, @function
IWDT_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_iwdt.c",132,0,0,.Ltext4
.Ltext4:
...
.Lscope4:
	...
	.align	1
	.stabs	"IWDT_Feed_The_Dog:F(0,15)",36,0,97,IWDT_Feed_The_Dog
	.export	IWDT_Feed_The_Dog
	.type	IWDT_Feed_The_Dog, @function
IWDT_Feed_The_Dog:
	.stabd	46,0,0
	.stabs	"../src/kf32f_basic_iwdt.c",132,0,0,.Ltext5
.Ltext5:
	.stabn	68,0,98,.LM16-.LFBB5
.LM16:
.LFBB5:
	.stabn	68,0,99,.LM17-.LFBB5
.LM17:
	LD	r5,#1073746432
	LD	r4,#1437226410
	ST.w	[r5+#1],r4
	.stabn	68,0,100,.LM18-.LFBB5
.LM18:
	JMP	lr
