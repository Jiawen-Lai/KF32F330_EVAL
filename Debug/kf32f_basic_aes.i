...
# 15 "D:\\workspace32\\KF32Fxxx_StdPeriph_Lib_V2.3\\inc/kf32f_basic_aes.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 17 "../src/kf32f_basic_aes.c" 2
# 36 "../src/kf32f_basic_aes.c"
void
AES_Reset ()
{
 RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((14))), TRUE);
 RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((14))), FALSE);
 PCLK_CTL3_Peripheral_Clock_Enable(((uint32_t)1<<((14))), TRUE);
}
...
# 68 "../src/kf32f_basic_aes.c"
   ...
   ((AES_SFRmap *) ((uint32_t)0x40002700))->CTL = SFR_Config (((AES_SFRmap *) ((uint32_t)0x40002700))->CTL,
      ~(((uint32_t)1<<((0))) | ((uint32_t)0x3<<((1))) | ((uint32_t)0x7<<((3))) | ((uint32_t)1<<((7))) | ((uint32_t)1<<((15))) | ((uint32_t)1<<((23)))),
      tmpreg);
...
AES_Struct_Init (AES_InitTypeDef* AESInitStruct)
{
    ...
    AESInitStruct->m_OFB = ((uint32_t) 0x0 << (0));

    AESInitStruct->m_ClockSelect = ((uint32_t) 0x0 << (1));

    AESInitStruct->m_ClockDiv = ((uint32_t) 0x0 << (3));

    AESInitStruct->m_Run = ((uint32_t) 0x0 << (7));

    AESInitStruct->m_FinishIntEn = ((uint32_t) 0x0 << (15));

    AESInitStruct->m_FinishIntClr = ((uint32_t) 0x0 << (23));
...
AES_KEY0_DATA (uint32_t DATA)
{
 ...
 ((AES_SFRmap *) ((uint32_t)0x40002700))->KEY0=DATA;
}
void
AES_KEY1_DATA (uint32_t DATA)
{

 ((AES_SFRmap *) ((uint32_t)0x40002700))->KEY1=DATA;
}
void
AES_KEY2_DATA (uint32_t DATA)
{

 ((AES_SFRmap *) ((uint32_t)0x40002700))->KEY2=DATA;
}
void
AES_KEY3_DATA (uint32_t DATA)
{

 ((AES_SFRmap *) ((uint32_t)0x40002700))->KEY3=DATA;
}
...
AES_INPUT0_DATA (uint32_t DATA)
{
 ...
 ((AES_SFRmap *) ((uint32_t)0x40002700))->INPUT0=DATA;
}
void
AES_INPUT1_DATA (uint32_t DATA)
{

 ((AES_SFRmap *) ((uint32_t)0x40002700))->INPUT1=DATA;
}
void
AES_INPUT2_DATA (uint32_t DATA)
{

 ((AES_SFRmap *) ((uint32_t)0x40002700))->INPUT2=DATA;
}
void
AES_INPUT3_DATA (uint32_t DATA)
{

 ((AES_SFRmap *) ((uint32_t)0x40002700))->INPUT3=DATA;
}
...
{
 uint32_t DATA;
 DATA=((AES_SFRmap *) ((uint32_t)0x40002700))->OUTPUT0;
...
{
 uint32_t DATA;
 DATA=((AES_SFRmap *) ((uint32_t)0x40002700))->OUTPUT1;
...
{
 uint32_t DATA;
 DATA=((AES_SFRmap *) ((uint32_t)0x40002700))->OUTPUT2;
...
{
 uint32_t DATA;
 DATA=((AES_SFRmap *) ((uint32_t)0x40002700))->OUTPUT3;
...
{
    if ((((AES_SFRmap *) ((uint32_t)0x40002700))->CTL & ((uint32_t)1<<((31)))) != RESET)
    {
...
AES_Start ()
{
  ...
  ((AES_SFRmap *) ((uint32_t)0x40002700))->CTL |= ((uint32_t)1<<((7)));
}
...
AES_CLR_Flag_Status ()
{
  ...
  ((AES_SFRmap *) ((uint32_t)0x40002700))->CTL |= 0x00800000;
  while(AES_Get_Flag_Status());
     ((AES_SFRmap *) ((uint32_t)0x40002700))->CTL &= 0xFF7FFFFF;
}
