...
/**
  * 外部启动延时时间配置
  */
#define EXT_START_DELAY_256              ((uint32_t)0)
#define EXT_START_DELAY_512              ((uint32_t)1)
#define EXT_START_DELAY_1024             ((uint32_t)2)
#define EXT_START_DELAY_2048             ((uint32_t)3)
#define EXT_START_DELAY_4096             ((uint32_t)4)
#define EXT_START_DELAY_8192             ((uint32_t)5)
#define EXT_START_DELAY_16384            ((uint32_t)6)
#define EXT_START_DELAY_32768            ((uint32_t)7)
#define EXT_START_DELAY_65536            ((uint32_t)8)
