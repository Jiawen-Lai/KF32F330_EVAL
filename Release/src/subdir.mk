...
src/%.o: ../src/%.c
	...
	kf32-gcc  -MMD -I"D:\workspace32\KF32_Bootloader_Sample" -I"D:\workspace32\KF32_Bootloader_Sample\inc" -I"D:\workspace32\KF32_Bootloader_Sample\inc" -I"C:/Program Files (x86)/ChipON IDE/KungFu32/ChiponCC32/include" -I"C:/Program Files (x86)/ChipON IDE/KungFu32/ChiponCC32/include/Sys" -save-temps -fno-builtin-printf -fno-builtin-fprintf -fno-builtin-fputs -c -funsigned-char -fsigned-bitfields -Wa,--kf32-arch=kf32r,-I"C:/Program Files (x86)/ChipON IDE/KungFu32/ChiponCC32/include" -ffunction-sections -fdata-sections -D"KF32F350MQV" -Wno-packed-bitfield-compat -std=gnu99 -O2 $< -o "$@"
