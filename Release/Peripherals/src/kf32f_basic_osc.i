# 1 "../Peripherals/src/kf32f_basic_osc.c"
# 1 "E:\\KF_Workspace\\Project_WorkSpace\\TEST_Prj\\Release//"
# 1 "<command-line>"
# 1 "../Peripherals/src/kf32f_basic_osc.c"
# 15 "../Peripherals/src/kf32f_basic_osc.c"
# 1 "E:\\KF_Workspace\\Project_WorkSpace\\TEST_Prj\\Peripherals\\inc/kf32f_basic_osc.h" 1
# 14 "E:\\KF_Workspace\\Project_WorkSpace\\TEST_Prj\\Peripherals\\inc/kf32f_basic_osc.h"
...
# 15 "E:\\KF_Workspace\\Project_WorkSpace\\TEST_Prj\\Peripherals\\inc/kf32f_basic_osc.h" 2
...
# 16 "../Peripherals/src/kf32f_basic_osc.c" 2
# 44 "../Peripherals/src/kf32f_basic_osc.c"
void
...
# 368 "../Peripherals/src/kf32f_basic_osc.c"
void
...
# 396 "../Peripherals/src/kf32f_basic_osc.c"
void
...
# 422 "../Peripherals/src/kf32f_basic_osc.c"
void
...
# 443 "../Peripherals/src/kf32f_basic_osc.c"
void
...
# 472 "../Peripherals/src/kf32f_basic_osc.c"
void
...
# 517 "../Peripherals/src/kf32f_basic_osc.c"
void
...
# 572 "../Peripherals/src/kf32f_basic_osc.c"
void
...
# 645 "../Peripherals/src/kf32f_basic_osc.c"
void
...
# 669 "../Peripherals/src/kf32f_basic_osc.c"
void
...
# 714 "../Peripherals/src/kf32f_basic_osc.c"
void
...
# 735 "../Peripherals/src/kf32f_basic_osc.c"
void
...
# 782 "../Peripherals/src/kf32f_basic_osc.c"
void
...
# 835 "../Peripherals/src/kf32f_basic_osc.c"
void
...
# 863 "../Peripherals/src/kf32f_basic_osc.c"
void
...
# 891 "../Peripherals/src/kf32f_basic_osc.c"
void
...
# 1045 "../Peripherals/src/kf32f_basic_osc.c"
void
...
# 1174 "../Peripherals/src/kf32f_basic_osc.c"
void
...
OSC_LP4M_INT_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((OSC_SFRmap *) ((uint32_t)0x40000000))->INT))),"i"((14)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((OSC_SFRmap *) ((uint32_t)0x40000000))->INT))),"i"((14)));
    }
}
...
OSC_Get_LP4MIF_INT_Flag (void)
{
    ...
    if ((((OSC_SFRmap *) ((uint32_t)0x40000000))->INT) & ((uint32_t)1<<((6))))
    {
