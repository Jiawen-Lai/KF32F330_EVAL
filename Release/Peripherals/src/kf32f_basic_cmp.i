# 1 "../Peripherals/src/kf32f_basic_cmp.c"
# 1 "E:\\KF_Workspace\\Project_WorkSpace\\TEST_Prj\\Release//"
# 1 "<command-line>"
# 1 "../Peripherals/src/kf32f_basic_cmp.c"
# 15 "../Peripherals/src/kf32f_basic_cmp.c"
# 1 "E:\\KF_Workspace\\Project_WorkSpace\\TEST_Prj\\Peripherals\\inc/kf32f_basic_cmp.h" 1
# 15 "E:\\KF_Workspace\\Project_WorkSpace\\TEST_Prj\\Peripherals\\inc/kf32f_basic_cmp.h"
...
# 16 "E:\\KF_Workspace\\Project_WorkSpace\\TEST_Prj\\Peripherals\\inc/kf32f_basic_cmp.h" 2
...
# 16 "../Peripherals/src/kf32f_basic_cmp.c" 2
...
void RST_CTL3_Peripheral_Reset_Enable(uint32_t RST_CTL3Periph,
                    FunctionalState NewState);
# 17 "../Peripherals/src/kf32f_basic_cmp.c" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 18 "../Peripherals/src/kf32f_basic_cmp.c" 2
# 75 "../Peripherals/src/kf32f_basic_cmp.c"
void
CMP_Reset ()
{
 RST_CTL1_Peripheral_Reset_Enable(((uint32_t)1<<((16))), TRUE);
 RST_CTL1_Peripheral_Reset_Enable(((uint32_t)1<<((16))), FALSE);
 PCLK_CTL1_Peripheral_Clock_Enable(((uint32_t)1<<((16))), TRUE);
}
...
CMP_Configuration (CMP_SFRmap * CMPx, CMP_InitTypeDef* CMPInitStruct)
{
    ...
    if(CMPx==((CMP_SFRmap *) ((uint32_t)0x40000800)))
    {
     ((void)0);
     ((void)0);
        ((void)0);
     ...
     ((void)0);
     ((void)0);
# 121 "../Peripherals/src/kf32f_basic_cmp.c"
    tmpreg = ((CMPInitStruct->m_PositiveInput ) |
      (CMPInitStruct->m_NegativeInput) |
      (CMPInitStruct->m_FallTriggerEnable << (19)) |
      (CMPInitStruct->m_RiseTriggerEnable << (18)) |
      (CMPInitStruct->m_Clock) |
      (CMPInitStruct->m_FrequencyDivision) |
      (CMPInitStruct->m_SampleNumber) |
      (CMPInitStruct->m_FilterEnable << (3)) |
      (CMPInitStruct->m_ScopecontrolEnable << (2)) |
      (CMPInitStruct->m_OutputPolarity));
    CMPx->CTL = SFR_Config (CMPx->CTL,
          ~(((uint32_t)0x7<<((28))) | ((uint32_t)0x7<<((24))) | ((uint32_t)1<<((19))) | ((uint32_t)1<<((18))) | ((uint32_t)0x3<<((16))) | ((uint32_t)0xFF<<((8))) | ((uint32_t)0x7<<((4))) | ((uint32_t)1<<((3))) | ((uint32_t)1<<((2))) | ((uint32_t)1<<((1)))),
          tmpreg);

     if ((CMPInitStruct->m_CmpEnable) != FALSE)
     {

         __asm volatile("SET [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((0)));
     }
     else
     {

         __asm volatile("CLR [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((0)));
     }
    }
    else if(CMPx==((CMP_SFRmap *) ((uint32_t)0x40000804)))
    {
     ((void)0);
     ((void)0);
        ((void)0);
     ...
     ((void)0);
     ((void)0);
# 170 "../Peripherals/src/kf32f_basic_cmp.c"
    tmpreg = ((CMPInitStruct->m_PositiveInput ) |
      (CMPInitStruct->m_NegativeInput) |
      (CMPInitStruct->m_FallTriggerEnable << (19)) |
      (CMPInitStruct->m_RiseTriggerEnable << (18)) |
      ...
      (CMPInitStruct->m_ScopecontrolEnable << (2)) |
      (CMPInitStruct->m_OutputPolarity));
    CMPx->CTL = SFR_Config (CMPx->CTL, ~(((uint32_t)0x7<<((28))) | ((uint32_t)0x7<<((24))) | ((uint32_t)1<<((19))) | ((uint32_t)1<<((18))) | ((uint32_t)0x3<<((16))) | ((uint32_t)0xFF<<((8))) | ((uint32_t)0x7<<((4))) | ((uint32_t)1<<((3))) | ((uint32_t)1<<((2))) | ((uint32_t)1<<((1)))), tmpreg);

     if ((CMPInitStruct->m_CmpEnable) != FALSE)
     {

         __asm volatile("SET [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((1)));
     }
     else
     {

         __asm volatile("CLR [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((1)));
     }

    }
    else if(CMPx==((CMP_SFRmap *) ((uint32_t)0x40000808)))
    {
        ((void)0);
         ((void)0);
            ((void)0);
         ...
         ((void)0);
         ((void)0);
# 218 "../Peripherals/src/kf32f_basic_cmp.c"
        tmpreg = ((CMPInitStruct->m_PositiveInput ) |
          (CMPInitStruct->m_NegativeInput) |
          (CMPInitStruct->m_FallTriggerEnable << (19)) |
          (CMPInitStruct->m_RiseTriggerEnable << (18)) |
        ...
        if ((CMPInitStruct->m_CmpEnable) != FALSE)
        {
            ...
            __asm volatile("SET [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((2)));
        }
        else
        {

            __asm volatile("CLR [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((2)));
        }
    }
    else if(CMPx==((CMP_SFRmap *) ((uint32_t)0x4000080C)))
    {
        ((void)0);
  ((void)0);
  ((void)0);
  ...
  ((void)0);
  ((void)0);
# 266 "../Peripherals/src/kf32f_basic_cmp.c"
    tmpreg = ((CMPInitStruct->m_PositiveInput ) |
      (CMPInitStruct->m_NegativeInput) |
      (CMPInitStruct->m_Clock) |
      (CMPInitStruct->m_FrequencyDivision) |
      ...
      (CMPInitStruct->m_ScopecontrolEnable << (2)) |
      (CMPInitStruct->m_OutputPolarity) |
      (CMPInitStruct->m_CmpEnable << (0)));
    CMPx->CTL = SFR_Config (CMPx->CTL, ~(((uint32_t)0x7<<((28))) | ((uint32_t)0x7<<((24))) | ((uint32_t)0x3<<((16))) | ((uint32_t)0xFF<<((8))) | ((uint32_t)0x7<<((4))) | ((uint32_t)1<<((3))) | ((uint32_t)1<<((2))) | ((uint32_t)1<<((1))) | ((uint32_t)1<<((0)))), tmpreg);

       if ((CMPInitStruct->m_FallTriggerEnable) != FALSE)
       {

           __asm volatile("SET [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((11)));
       }
       else
       {

           __asm volatile("CLR [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((11)));
       }

       if ((CMPInitStruct->m_RiseTriggerEnable) != FALSE)
       {

           __asm volatile("SET [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((10)));
       }
       else
       {

           __asm volatile("CLR [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((10)));
       }
    }
}
...
CMP_Struct_Init (CMP_InitTypeDef* CMPInitStruct)
{
    ...
    CMPInitStruct->m_PositiveInput = ((uint32_t)0 << (28));

    CMPInitStruct->m_NegativeInput = ((uint32_t)0 << (24));

    CMPInitStruct->m_FallTriggerEnable = FALSE;

    CMPInitStruct->m_RiseTriggerEnable = FALSE;

    CMPInitStruct->m_Clock = ((uint32_t)0x0 << (16));

    CMPInitStruct->m_FrequencyDivision = 0x00;

    CMPInitStruct->m_SampleNumber = ((uint32_t)0x0 << (4));

    CMPInitStruct->m_FilterEnable = FALSE;

    CMPInitStruct->m_ScopecontrolEnable = FALSE;

    CMPInitStruct->m_OutputPolarity =((uint32_t)0<<(1));

    CMPInitStruct->m_CmpEnable =FALSE;
}
# 345 "../Peripherals/src/kf32f_basic_cmp.c"
void
CMP0_POSITIVE_INPUT_SELECT (uint32_t Select)
{
    ...
    (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL),
                               ~((uint32_t)0x7<<((28))),
                               Select);
}
# 368 "../Peripherals/src/kf32f_basic_cmp.c"
void
...
# 391 "../Peripherals/src/kf32f_basic_cmp.c"
void
CMP1_POSITIVE_INPUT_SELECT (uint32_t Select)
{
    ...
    (((CMP_SFRmap *) ((uint32_t)0x40000804))->CTL) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000804))->CTL),
                               ~((uint32_t)0x7<<((28))),
                               Select);
}
# 414 "../Peripherals/src/kf32f_basic_cmp.c"
void
...
# 437 "../Peripherals/src/kf32f_basic_cmp.c"
void
CMP2_POSITIVE_INPUT_SELECT (uint32_t Select)
{
    ...
    (((CMP_SFRmap *) ((uint32_t)0x40000808))->CTL) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000808))->CTL),
                               ~((uint32_t)0x7<<((28))),
                               Select);
}
# 460 "../Peripherals/src/kf32f_basic_cmp.c"
void
...
# 484 "../Peripherals/src/kf32f_basic_cmp.c"
void
CMP3_POSITIVE_INPUT_SELECT (uint32_t Select)
{
    ...
    if(Select==((uint32_t)1 << (31)))
    {
     __asm volatile("SET [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x4000080C))->CTL)),"i"((31)));
    }
    else
    {

    __asm volatile("CLR [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x4000080C))->CTL)),"i"((31)));
    (((CMP_SFRmap *) ((uint32_t)0x4000080C))->CTL) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x4000080C))->CTL),
                               ~((uint32_t)0x7<<((28))),
                               Select);
    }
}
# 516 "../Peripherals/src/kf32f_basic_cmp.c"
void
...
# 534 "../Peripherals/src/kf32f_basic_cmp.c"
void
...
# 605 "../Peripherals/src/kf32f_basic_cmp.c"
void
CMP_OUTPUT_SELECT (uint32_t Select)
{
    ...
    (((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL),
                               ~((uint32_t)0x3<<((20))),
                               Select);
}
...
CMP3_Cmd (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x4000080C))->CTL)),"i"((0)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x4000080C))->CTL)),"i"((0)));
    }
}
# 717 "../Peripherals/src/kf32f_basic_cmp.c"
FlagStatus
CMP0_Read_Output_State ()
{

 if (((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL & ((uint32_t)1<<((28))))
 {
...
CMP1_Read_Output_State ()
{
 ...
 if (((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL & ((uint32_t)1<<((29))))
 {
...
CMP2_Read_Output_State ()
{
 ...
 if (((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL & ((uint32_t)1<<((30))))
 {
...
CMP3_Read_Output_State ()
{
 ...
 if (((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL & ((uint32_t)1<<((31))))
 {
...
CMP0_Get_Updata_INT_Flag ()
{
    ...
    if (((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL & ((uint32_t)1<<((24))))
    {
...
CMP1_Get_Updata_INT_Flag ()
{
    ...
    if (((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL & ((uint32_t)1<<((25))))
    {
...
CMP2_Get_Updata_INT_Flag ()
{
    ...
    if (((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL & ((uint32_t)1<<((26))))
    {
...
CMP3_Get_Updata_INT_Flag ()
{
    ...
    if (((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL & ((uint32_t)1<<((27))))
    {
...
# 881 "../Peripherals/src/kf32f_basic_cmp.c"
void
...
CMP0_Clear_Trigger_INT_Flag ()
{
    ...
    __asm volatile("SET [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((16)));
    while(((((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL) & ((uint32_t)1<<((24))))>>(24));
    __asm volatile("CLR [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((16)));
}
...
CMP1_Clear_Trigger_INT_Flag ()
{
    ...
    __asm volatile("SET [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((17)));
    while(((((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL) & ((uint32_t)1<<((25))))>>(25));
    __asm volatile("CLR [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((17)));
}
...
CMP2_Clear_Trigger_INT_Flag ()
{
    ...
    __asm volatile("SET [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((18)));
    while(((((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL) & ((uint32_t)1<<((26))))>>(26));
    __asm volatile("CLR [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((18)));
}
...
CMP3_Clear_Trigger_INT_Flag ()
{
    ...
    __asm volatile("SET [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((19)));
    while(((((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL) & ((uint32_t)1<<((27))))>>(27));
    __asm volatile("CLR [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((19)));
}
...
CMP0_INT_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((12)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((12)));
    }
}
void
CMP1_INT_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((13)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((13)));
    }
}
void
CMP2_INT_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((14)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((14)));
    }
}
void
CMP3_INT_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((15)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((15)));
    }
}
# 1029 "../Peripherals/src/kf32f_basic_cmp.c"
void
...
CMP_BEMF_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((4)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(((CMP_SFRmap *) ((uint32_t)0x40000810))->CTL)),"i"((4)));
    }
}
