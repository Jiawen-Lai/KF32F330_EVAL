# 1 "../Peripherals/src/kf32f_basic_i2c.c"
# 1 "E:\\KF_Workspace\\Project_WorkSpace\\TEST_Prj\\Release//"
# 1 "<command-line>"
# 1 "../Peripherals/src/kf32f_basic_i2c.c"
# 15 "../Peripherals/src/kf32f_basic_i2c.c"
# 1 "E:\\KF_Workspace\\Project_WorkSpace\\TEST_Prj\\Peripherals\\inc/kf32f_basic_i2c.h" 1
# 15 "E:\\KF_Workspace\\Project_WorkSpace\\TEST_Prj\\Peripherals\\inc/kf32f_basic_i2c.h"
...
# 16 "E:\\KF_Workspace\\Project_WorkSpace\\TEST_Prj\\Peripherals\\inc/kf32f_basic_i2c.h" 2
...
# 16 "../Peripherals/src/kf32f_basic_i2c.c" 2
...
void RST_CTL3_Peripheral_Reset_Enable(uint32_t RST_CTL3Periph,
                    FunctionalState NewState);
# 17 "../Peripherals/src/kf32f_basic_i2c.c" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 18 "../Peripherals/src/kf32f_basic_i2c.c" 2
# 38 "../Peripherals/src/kf32f_basic_i2c.c"
void
...
# 76 "../Peripherals/src/kf32f_basic_i2c.c"
}
...
I2C_Configuration (I2C_SFRmap* I2Cx, I2C_InitTypeDef* i2cInitStruct)
{
    ...
    ((void)0);
    ((void)0);
# 105 "../Peripherals/src/kf32f_basic_i2c.c"
...
# 168 "../Peripherals/src/kf32f_basic_i2c.c"
void
...
# 195 "../Peripherals/src/kf32f_basic_i2c.c"
void
...
# 301 "../Peripherals/src/kf32f_basic_i2c.c"
void
...
# 355 "../Peripherals/src/kf32f_basic_i2c.c"
void
...
# 452 "../Peripherals/src/kf32f_basic_i2c.c"
void
...
# 480 "../Peripherals/src/kf32f_basic_i2c.c"
void
...
# 613 "../Peripherals/src/kf32f_basic_i2c.c"
void
...
# 648 "../Peripherals/src/kf32f_basic_i2c.c"
void
...
# 726 "../Peripherals/src/kf32f_basic_i2c.c"
void
...
I2C_Bus_Error_INT_Enable(I2C_SFRmap* I2Cx,FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(I2Cx->IER)),"i"((18)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(I2Cx->IER)),"i"((18)));
    }
}
