# 1 "../Peripherals/src/kf32f_basic_can.c"
# 1 "E:\\KF_Workspace\\Project_WorkSpace\\SmartDriver_Bootloader\\Release//"
# 1 "<command-line>"
# 1 "../Peripherals/src/kf32f_basic_can.c"
# 16 "../Peripherals/src/kf32f_basic_can.c"
# 1 "E:\\KF_Workspace\\Project_WorkSpace\\SmartDriver_Bootloader\\Peripherals\\inc/kf32f_basic_can.h" 1
# 14 "E:\\KF_Workspace\\Project_WorkSpace\\SmartDriver_Bootloader\\Peripherals\\inc/kf32f_basic_can.h"
...
# 15 "E:\\KF_Workspace\\Project_WorkSpace\\SmartDriver_Bootloader\\Peripherals\\inc/kf32f_basic_can.h" 2
...
# 17 "../Peripherals/src/kf32f_basic_can.c" 2
...
void RST_CTL3_Peripheral_Reset_Enable(uint32_t RST_CTL3Periph,
                    FunctionalState NewState);
# 18 "../Peripherals/src/kf32f_basic_can.c" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 19 "../Peripherals/src/kf32f_basic_can.c" 2
# 67 "../Peripherals/src/kf32f_basic_can.c"
void
...
# 120 "../Peripherals/src/kf32f_basic_can.c"
}
# 129 "../Peripherals/src/kf32f_basic_can.c"
void
...
# 186 "../Peripherals/src/kf32f_basic_can.c"
void
...
# 283 "../Peripherals/src/kf32f_basic_can.c"
uint32_t
...
# 316 "../Peripherals/src/kf32f_basic_can.c"
FlagStatus
...
# 375 "../Peripherals/src/kf32f_basic_can.c"
void
...
# 448 "../Peripherals/src/kf32f_basic_can.c"
void
...
# 469 "../Peripherals/src/kf32f_basic_can.c"
void
...
# 496 "../Peripherals/src/kf32f_basic_can.c"
void
...
# 636 "../Peripherals/src/kf32f_basic_can.c"
uint8_t
...
# 692 "../Peripherals/src/kf32f_basic_can.c"
void
...
# 803 "../Peripherals/src/kf32f_basic_can.c"
void
...
# 880 "../Peripherals/src/kf32f_basic_can.c"
void
                    ...
                    uint32_t ReceiveOffset, CAN_MessageTypeDef* canInitStruct)
{
  ...
  case ((uint32_t)0x40001180):
   ...
   break;
# 928 "../Peripherals/src/kf32f_basic_can.c"
  default:
   break;
    }
...
CAN_Transmit_Repeat (CAN_SFRmap* CANx)
{
 volatile unsigned int temp;
    ...
    while(!(CANx->CTLR & ((uint32_t)1<<((21)))));
    __asm volatile("CLR [%0], #%1"::"r"(&(CANx->CTLR)),"i"((8)));

}
# 1247 "../Peripherals/src/kf32f_basic_can.c"
void
...
# 1275 "../Peripherals/src/kf32f_basic_can.c"
void
...
# 1302 "../Peripherals/src/kf32f_basic_can.c"
void
...
# 1325 "../Peripherals/src/kf32f_basic_can.c"
void
...
# 1379 "../Peripherals/src/kf32f_basic_can.c"
FlagStatus
...
# 1417 "../Peripherals/src/kf32f_basic_can.c"
void
...
# 1448 "../Peripherals/src/kf32f_basic_can.c"
void
